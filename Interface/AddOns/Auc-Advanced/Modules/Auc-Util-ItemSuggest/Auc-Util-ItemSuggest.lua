--[[
	...
	Revision: $Id: Auc-Util-ItemSuggest.lua 4003 2009-01-19 17:44:53Z anaral $
...
function lib.ProcessTooltip(tooltip, name, hyperlink, quality, quantity, cost, additional)
	if (get("util.itemsuggest.enablett")) then
		...
		tooltip:AddLine("建议: ".. aimethod.. " 物品")
	end
end
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Auc-Util-ItemSuggest/Auc-Util-ItemSuggest.lua $", "$Rev: 4003 $")
