--[[
	...
	Revision: $Id: OutlierFilter.lua 3855 2008-11-22 02:28:24Z kandoko $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Auc-Filter-Outlier/OutlierFilter.lua $", "$Rev: 3855 $")
