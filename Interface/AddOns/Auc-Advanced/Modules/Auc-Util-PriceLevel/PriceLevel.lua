--[[
	...
	Revision: $Id: PriceLevel.lua 4003 2009-01-19 17:44:53Z anaral $
...
function lib.ProcessTooltip(tooltip, name, hyperlink, quality, quantity, cost, additional)
	...
	tooltip:AddLine(("价格级别: %d%%"):format(priceLevel), perItem, r,g,b)
end
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Auc-Util-PriceLevel/PriceLevel.lua $", "$Rev: 4003 $")
