--[[
	...
	Revision: $Id: AskPrice.lua 4004 2009-01-19 21:10:41Z anaral $
...
function private.GetVersion()
	return tonumber(("$Revision: 4004 $"):match("(%d+)")), (AucAdvanced.GetCurrentRevision()) --We just want the first return from GetCurrentRevision()
end
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Auc-Util-AskPrice/AskPrice.lua $", "$Rev: 4004 $")
