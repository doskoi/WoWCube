--[[
	...
	Revision: $Id: CompactUI.lua 4004 2009-01-19 21:10:41Z anaral $
...
function private.HookAH()
	...
	createHeader(1, 1, "堆叠", bOne.Count)
	createHeader(2, 1, "拍卖的物品", bOne.IconButton, bOne.Name, 0, 0, { "Name", "Quality" })
	createHeader(3, -1, "需求", bOne.rLevel)
	createHeader(4, -1, "等级", bOne.iLevel)
	createHeader(5, 1, "时间", bOne.tLeft)
	createHeader(6, 1, "拍卖者", bOne.Owner)
	createHeader(7, -1, "价格", bOne.Value, bOne.Bid, -110, 0, {"Buy total", "Bid total", "Buy each", "Bid each"})
	createHeader(8, 1, "%", bOne.Value, nil, 0, -2)
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Auc-Util-CompactUI/CompactUI.lua $", "$Rev: 4004 $")
