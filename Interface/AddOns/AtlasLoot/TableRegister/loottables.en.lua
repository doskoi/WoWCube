...
------------------------
	...
	AtlasLoot_TableNames["Mounts11"] = { BabbleFaction["Alliance"].." "..AL["Mounts"].." - Classic WoW", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Mounts12"] = { BabbleFaction["Horde"].." "..AL["Mounts"].." - Classic WoW", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Mounts13"] = { AL["Mounts"].." - Classic WoW", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["Mounts21"] = { AL["Mounts"].." - The Burning Crusade", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["Mounts22"] = { AL["Mounts"].." - The Burning Crusade", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["Mounts23"] = { AL["Mounts"].." - The Burning Crusade", "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["Mounts24"] = { AL["Mounts"].." - The Burning Crusade", "AtlasLootBurningCrusade" };
	...
	AtlasLoot_TableNames["Pets4"] = { AL["Pets"].." - "..AL["Mythical"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Pets5"] = { AL["Pets"].." - "..AL["Reptiles"], "AtlasLootWotLK" };
...
--	AtlasLoot_TableNames["LakeWintergrasp1"] = { AL["Lake Wintergrasp"], "AtlasLootWotLK" };
--	AtlasLoot_TableNames["LakeWintergrasp2"] = { AL["Lake Wintergrasp"], "AtlasLootWotLK" };
  --Misc Other PvP
	...
	AtlasLoot_TableNames["PvP70NonSet2"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Cloth"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["PvP70NonSet3"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Leather"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["PvP70NonSet4"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Mail"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["PvP70NonSet5"] = { AL["PvP Non-Set Epics"]..": "..BabbleInventory["Plate"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["PvP80NonSet1"] = { AL["PvP Non-Set Epics"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["PvP80NonSet2"] = { AL["PvP Non-Set Epics"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["PvP80NonSet3"] = { AL["PvP Non-Set Epics"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["PvP80NonSet4"] = { AL["PvP Non-Set Epics"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["PvP80NonSet5"] = { AL["PvP Non-Set Epics"], "AtlasLootWotLK" };
	...
	AtlasLoot_TableNames["PvP80Weapons1"] = { AL["Savage Gladiator\'s Weapons"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["PvP80Weapons2"] = { AL["Savage Gladiator\'s Weapons"], "AtlasLootWotLK" };
    AtlasLoot_TableNames["DeadlyGladiatorWeapons1"] = { AL["Deadly Gladiator\'s Weapons"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["DeadlyGladiatorWeapons2"] = { AL["Deadly Gladiator\'s Weapons"], "AtlasLootWotLK" };
