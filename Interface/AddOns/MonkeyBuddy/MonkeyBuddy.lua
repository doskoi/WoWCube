...
function MonkeyBuddySpeedFrame_Refresh()
    ...
    -- Setup check buttons
    for key, value in pairs(MonkeyBuddySpeed_CheckButtons) do
    ...
    -- Setup Sliders
    for key, value in pairs(MonkeyBuddySpeed_Sliders) do
...
function MonkeyBuddyClockFrame_Refresh()
    ...
    -- Setup check buttons
    for key, value in pairs(MonkeyBuddyClock_CheckButtons) do
    ...
    -- Setup Sliders
    for key, value in pairs(MonkeyBuddyClock_Sliders) do
...
function MonkeyBuddyOptionsCheckButton_OnClick()   
--[[ 
    if (this:GetChecked()) then
	MonkeyBuddyConfig[MonkeyBuddy.m_strPlayer].m_bDismissed = false;
	MonkeyBuddyIconButton:Show();
...
function MonkeyQuestDailiesCheckButton_OnClick()    
    if (this:GetChecked()) then
	local enable = 1;
...
local MonkeyBuddyStatus = CreateFrame("FRAME", "MQStatus", MonkeyBuddyOptions)
...
local MonkeyBuddyStatus = CreateFrame("FRAME", "MonkeyBuddyIconOption", MonkeyBuddyOptions)
MonkeyBuddyStatus:SetBackdrop({bgFile = "Interface/Tooltips/UI-Tooltip-Background", 
	edgeFile = "Interface/Tooltips/UI-Tooltip-Border", 
	tile = true, tileSize = 16, edgeSize = 16, 
	insets = { left = 4, right = 4, top = 4, bottom = 4 }})
...
MonkeyBuddyOptionsCheckButton = CreateFrame("CheckButton", "MonkeyBuddyCheckOption", MonkeyBuddyOptions, "MonkeyBuddyOptionsCheckButtonTemplate")
...
local MonkeyQuestDailies = CreateFrame("FRAME", "MonkeyQuestDailiesOption", MonkeyBuddyOptions)
...
MonkeyQuestDailiesCheckButton = CreateFrame("CheckButton", "MonkeyQuestDailiesCheckButton", MonkeyBuddyOptions, "MonkeyQuestDailiesCheckButtonTemplate")
...
local MonkeyBuddyOptionsMBButton = CreateFrame("Button", nil, MonkeyBuddyOptions, "UIPanelButtonTemplate2")
