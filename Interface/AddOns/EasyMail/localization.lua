...
EASYMAIL_CLEAROPTION = "清除列表";
EASYMAIL_ATTBUTTONTEXT = "取得全部";
EASYMAIL_CHECKALLTEXT = "勾选全部";
EASYMAIL_CLEARALLTEXT = "取消勾选";
EASYMAIL_GETALLTEXT = "取得附件";
EASYMAIL_GUILDTEXT = "公会成员";
EASYMAIL_FRIENDSTEXT = "好友";
EASYMAIL_RECEIVEMONEY = "你收到的金额: %s %s";
EASYMAIL_FROMAUCTION = "(拍卖的 %s)";
EASYMAIL_FROM = "(来自 %s)";
EASYMAIL_MONEYSUBJECT = "金币: %s";
EASYMAIL_TOTALMONEY = "从附件收到的总金额: %s";
EASYMAIL_NOTEXT = "<无文字>";
elseif  ( GetLocale() == "zhTW" ) then
EASYMAIL_CLEAROPTION = "清除列表";
EASYMAIL_ATTBUTTONTEXT = "取得全部";
EASYMAIL_CHECKALLTEXT = "勾選全部";
EASYMAIL_CLEARALLTEXT = "取消勾選";
EASYMAIL_GETALLTEXT = "取得附件";
EASYMAIL_GUILDTEXT = "公會成員";
EASYMAIL_FRIENDSTEXT = "好友";
EASYMAIL_RECEIVEMONEY = "你收到的金額: %s %s";
EASYMAIL_FROMAUCTION = "(拍賣的 %s)";
EASYMAIL_FROM = "(來自 %s)";
EASYMAIL_MONEYSUBJECT = "金幣: %s";
EASYMAIL_TOTALMONEY = "從附件收到的總金額: %s";
EASYMAIL_NOTEXT = "<無文字>";
end