--[[
	...
	Revision: $Id: InfCommand.lua 3965 2009-01-09 05:39:00Z Psyonix $
...
Informant_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Informant/InfCommand.lua $", "$Rev: 3965 $")
