--[[
	...
	Revision: $Id: GatherStorage.lua 768 2008-10-25 20:49:04Z Esamynn $
...
--]]
Gatherer_RegisterRevision("$URL: http://svn.norganna.org/gatherer/trunk/Gatherer/GatherStorage.lua $", "$Rev: 768 $")
...
local dbVersion = 2
--HACK, version 3 is the same as version 2, except for a shifting for the EPL map change in wow 3.0
if ( (GetBuildInfo()):sub(1, 3) ~= "2.4" ) then
	dbVersion = 3
end
