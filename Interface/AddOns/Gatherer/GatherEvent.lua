--[[
	...
	Revision: $Id: GatherEvent.lua 754 2008-10-14 04:43:39Z Esamynn $
...
Gatherer_RegisterRevision("$URL: http://svn.norganna.org/gatherer/trunk/Gatherer/GatherEvent.lua $", "$Rev: 754 $")
...
function Gather_Register()
	if ( gLim_RegisterButton and IsAddOnLoaded("Gatherer")  ) then
	gLim_RegisterButton (
		GetAddOnMetadata("Gatherer", "Title"),
		GATHERER_OPTION_TEXT,
		"Interface\\Icons\\INV_Misc_Herb_Dreamingglory",
		function()
			Gatherer.Config.MakeGuiConfig()
			if ( Gatherer.Config.Gui:IsShown() ) then
				Gatherer.Config.Gui:Hide()
			else
