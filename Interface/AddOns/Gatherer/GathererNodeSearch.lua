--[[
	...
	Revision: $Id: GathererNodeSearch.lua 754 2008-10-14 04:43:39Z Esamynn $
...
Gatherer_RegisterRevision("$URL: http://svn.norganna.org/gatherer/trunk/Gatherer/GathererNodeSearch.lua $", "$Rev: 754 $")
...
--Populate the select box options.  vals= {GetMapContinents()}  would work automatically, but the function is not yet usable when we create these frames
local vals = {{"all", "All"}, {1, "Kalimdor"}, {2, "Eastern Kingdoms"}, {3, "Outland"}}
