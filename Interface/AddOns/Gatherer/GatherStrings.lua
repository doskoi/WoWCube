--[[
	...
	AddOn: Gatherer
	Revision: $Id: GatherStrings.lua 754 2008-10-14 04:43:39Z Esamynn $
	Version: 3.1.9 (<%codename%>)
...
GathererLocalizations = {
	...
	ruRU = {
		...
		-- Section: Keybinding Text
		["BINDING_HEADER_GATHERER"]	= "Собиратель";
		["BINDING_NAME_GATHERER_TOGGLE_OPTIONS_DIALOG"]	= "Переключение Окна Опций";

		-- Section: Node Category Names
		["HERB_NETHERDUST"]	= "Пыльца хаотического пыльника";
		["ORE_ADAMANTITE"]	= "Адамантитовая руда";
		["ORE_BLOODSTONE"]	= "Бедная кровавая руда";
		["ORE_COPPER"]	= "Медь";
		["ORE_DARKIRON"]	= "Тёмное железо";
		["ORE_FELIRON"]	= "Оскверненное железо";
		["ORE_GOLD"]	= "Золото";
		...
		["ORE_RADAMANTITE"]	= "Богатая Адамантитовая Руда";
		["ORE_RTHORIUM"]	= "Богатая Ториевая Руда";
		["ORE_SILVER"]	= "Серебро";
		...
		["TREASURE_GLOWCAP"]	= "Пламеневики";
		["TREASURE_NIGHTDRAGON"]	= "Дыхание Ночного Дракона";
		["TREASURE_POWERCRYST"]	= "Мощные кристаллы";
		["TREASURE_SHELLFISHTRAP"]	= "Раковина моллюска";
		["TREASURE_SONGFLOWER"]	= "Песньцветы";
		["TREASURE_UNGOROSOIL"]	= "Земля Ан-Горо";
		["TREASURE_WHIPPERROOT"]	= "Лохматые корневища";
