--[[
	...
	Revision: $Id: GatherNodes.lua 783 2008-12-05 08:13:41Z Esamynn $
...
if (region == "deDE") then -- German
	Gatherer.Nodes.Names = {
		...
		["Kobaltader"] = 189978, -- Cobalt Node
		["Reiche Kobaltader"] = 189979, -- Rich Cobalt Node
		["Saronitader"] = 189980, -- Saronite Node
		["Reiche Saronitader"] = 189981, -- Rich Saronite Node
		["Titanader"] = 191133, -- Titanium Node
...
elseif (region == "esES") then -- Spanish
	Gatherer.Nodes.Names = {
		...
		["Nodo de cobalto"] = 189978, -- Cobalt Node
		["Nodo de cobalto rico"] = 189979, -- Rich Cobalt Node
		["Nodo de saronita"] = 189980, -- Saronite Node
		["Nodo de saronita rico"] = 189981, -- Rich Saronite Node
		["Nodo de titanio"] = 191133, -- Titanium Node
...
elseif (region == "esMX") then -- Latin American Spanish
	Gatherer.Nodes.Names = {
	}
elseif (region == "frFR") then -- French
	Gatherer.Nodes.Names = {
		...
		["Gisement de cobalt"] = 189978, -- Cobalt Node
		["Riche gisement de cobalt"] = 189979, -- Rich Cobalt Node
		["Gisement de saronite"] = 189980, -- Saronite Node
		["Riche gisement de saronite"] = 189981, -- Rich Saronite Node
		["Gisement de titane"] = 191133, -- Titanium Node
		...
		["Verpérenne"] = 191019, -- Adder's Tongue
...
elseif (region == "ruRU") then -- Russian
	Gatherer.Nodes.Names = {
		...
		["Залежи кобальта"] = 189978, -- Cobalt Node
		["Богатые залежи кобальта"] = 189979, -- Rich Cobalt Node
		["Месторождение саронита"] = 189980, -- Saronite Node
		["Богатое месторождение саронита"] = 189981, -- Rich Saronite Node
		["Залежи титана"] = 191133, -- Titanium Node
		["Сребролист"] = 1617, -- Silverleaf
		["Мироцвет"] = 1618, -- Peacebloom
		["Землекорень"] = 1619, -- Earthroot
...
elseif (region == "zhTW") then -- Traditional Chinese
	Gatherer.Nodes.Names = {
		...
		["銀礦"] = 1733, -- Silver Vein
		["金礦石"] = 1734, -- Gold Vein
		["鐵礦石"] = 1735, -- Iron Deposit
		["秘銀礦脈"] = 2040, -- Mithril Deposit
		["真銀礦石"] = 2047, -- Truesilver Deposit
		...
		["軟泥覆蓋的祕銀礦脈"] = 123310, -- Ooze Covered Mithril Deposit
		["軟泥覆蓋的瑟銀礦脈"] = 123848, -- Ooze Covered Thorium Vein
		["黑鐵礦脈"] = 165658, -- Dark Iron Deposit
		["富瑟銀礦"] = 175404, -- Rich Thorium Vein
		...
		["鈷藍礦點"] = 189978, -- Cobalt Node
		["豐沃的鈷藍礦點"] = 189979, -- Rich Cobalt Node
		["薩鋼礦點"] = 189980, -- Saronite Node
		["豐沃的薩鋼礦點"] = 189981, -- Rich Saronite Node
		["泰坦鋼礦點"] = 191133, -- Titanium Node
		["銀葉草"] = 1617, -- Silverleaf
		["寧神花"] = 1618, -- Peacebloom
		["地根草"] = 1619, -- Earthroot
		["魔皇草"] = 1620, -- Mageroyal
...
Gatherer.Nodes.PrimaryItems = {
	[189978] = 36909, -- Cobalt Node
	[189979] = 36909, -- Rich Cobalt Node
	[189980] = 36912, -- Saronite Node
	[189981] = 36912, -- Rich Saronite Node
	[191133] = 36910, -- Titanium Node
