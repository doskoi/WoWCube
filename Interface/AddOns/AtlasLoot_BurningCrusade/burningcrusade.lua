...
--- World Bosses
	...
	AtlasLoot_Data["AuchCryptsExarch"] = {
		...
		{ 13, 21525, "", "=q2=Green Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
		{ 15, 33836, "", "=q1=The Exarch's Soul Gem", "=ds=#m3#", "", "100%"};
		...
		{ 30, 21525, "", "=q2=Green Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
	...
	AtlasLoot_Data["AuchShadowGrandmaster"] = {
		...
		{ 8, 21525, "", "=q2=Green Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
		{ 10, 30827, "", "=q1=Lexicon Demonica", "=ds=#m3#", "", "100%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 18, 30563, "", "=q4=Regal Tanzanite", "=ds=#e7#", "", "16.67%"};
		{ 19, 30559, "", "=q4=Etched Fire Opal", "=ds=#e7#", "", "17.85%"};
	...
	AtlasLoot_Data["BTNajentus"] = {
		{ 1, 32239, "", "=q4=Slippers of the Seacaller", "=ds=#s12#, #a1#"};
		{ 2, 32240, "", "=q4=Guise of the Tidal Lurker", "=ds=#s1#, #a2#"};
		{ 3, 32377, "", "=q4=Mantle of Darkness", "=ds=#s3#, #a2#"};
		{ 4, 32241, "", "=q4=Helm of Soothing Currents", "=ds=#s1#, #a3#"};
		{ 5, 32234, "", "=q4=Fists of Mukoa", "=ds=#s9#, #a3#"};
		{ 6, 32242, "", "=q4=Boots of Oceanic Fury", "=ds=#s12#, #a3#"};
		{ 7, 32232, "", "=q4=Eternium Shell Bracers", "=ds=#s8#, #a4#"};
		{ 8, 32243, "", "=q4=Pearl Inlaid Boots", "=ds=#s12#, #a4#"};
		{ 9, 32245, "", "=q4=Tide-stomper's Greaves", "=ds=#s12#, #a4#"};
		{ 16, 32238, "", "=q4=Ring of Calming Waves", "=ds=#s13#"};
		{ 17, 32247, "", "=q4=Ring of Captured Storms", "=ds=#s13#"};
		{ 18, 32237, "", "=q4=The Maelstrom's Fury", "=ds=#h3#, #w4#"};
	...
	AtlasLoot_Data["BTSupremus"] = {
		{ 1, 32256, "", "=q4=Waistwrap of Infinity", "=ds=#s10#, #a1#"};
		{ 2, 32252, "", "=q4=Nether Shadow Tunic", "=ds=#s5#, #a2#"};
		{ 3, 32259, "", "=q4=Bands of the Coming Storm", "=ds=#s8#, #a3#"};
		{ 4, 32251, "", "=q4=Wraps of Precise Flight", "=ds=#s8#, #a3#"};
		{ 5, 32258, "", "=q4=Naturalist's Preserving Cinch", "=ds=#s10#, #a3#"};
		{ 6, 32250, "", "=q4=Pauldrons of Abyssal Fury", "=ds=#s3#, #a4#"};
		{ 8, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 16, 32260, "", "=q4=Choker of Endless Nightmares", "=ds=#s2#"};
		{ 17, 32261, "", "=q4=Band of the Abyssal Lord", "=ds=#s13#"};
		{ 18, 32257, "", "=q4=Idol of the White Stag", "=ds=#s16#, #w14#"};
		{ 19, 32254, "", "=q4=The Brutalizer", "=ds=#h1#, #w1#"};
	...
	AtlasLoot_Data["BTGorefiend"] = {
		{ 1, 32323, "", "=q4=Shadowmoon Destroyer's Drape", "=ds=#s4#"};
		{ 2, 32329, "", "=q4=Cowl of Benevolence", "=ds=#s1#, #a1#"};
		{ 3, 32327, "", "=q4=Robe of the Shadow Council", "=ds=#s5#, #a1#"};
		{ 4, 32324, "", "=q4=Insidious Bands", "=ds=#s8#, #a2#"};
		{ 5, 32328, "", "=q4=Botanist's Gloves of Growth", "=ds=#s9#, #a2#"};
		{ 6, 32510, "", "=q4=Softstep Boots of Tracking", "=ds=#s12#, #a3#"};
		{ 7, 32280, "", "=q4=Gauntlets of Enforcement", "=ds=#s9#, #a4#"};
		{ 8, 32512, "", "=q4=Girdle of Lordaeron's Fallen", "=ds=#s10#, #a4#"};
		{ 16, 32330, "", "=q4=Totem of Ancestral Guidance", "=ds=#s16#, #w15#"};
		{ 17, 32348, "", "=q4=Soul Cleaver", "=ds=#h2#, #w1#"};
	...
	AtlasLoot_Data["BTBloodboil"] = {
		{ 1, 32337, "", "=q4=Shroud of Forgiveness", "=ds=#s4#"};
		{ 2, 32338, "", "=q4=Blood-cursed Shoulderpads", "=ds=#s3#, #a1#"};
		{ 3, 32340, "", "=q4=Garments of Temperance", "=ds=#s5#, #a1#"};
		{ 4, 32339, "", "=q4=Belt of Primal Majesty", "=ds=#s10#, #a2#"};
		{ 5, 32334, "", "=q4=Vest of Mounting Assault", "=ds=#s5#, #a3#"};
		{ 6, 32342, "", "=q4=Girdle of Mighty Resolve", "=ds=#s10#, #a4#"};
		{ 7, 32333, "", "=q4=Girdle of Stability", "=ds=#s10#, #a4#"};
		{ 8, 32341, "", "=q4=Leggings of Divine Retribution", "=ds=#s11#, #a4#"};
		{ 16, 32335, "", "=q4=Unstoppable Aggressor's Ring", "=ds=#s13#"};
		{ 17, 32501, "", "=q4=Shadowmoon Insignia", "=ds=#s14#"};
		{ 18, 32269, "", "=q4=Messenger of Fate", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["BTEssencofSouls"] = {
		{ 1, 32353, "", "=q4=Gloves of Unfailing Faith", "=ds=#s9#, #a1#"};
		{ 2, 32351, "", "=q4=Elunite Empowered Bracers", "=ds=#s8#, #a2#"};
		{ 3, 32347, "", "=q4=Grips of Damnation", "=ds=#s9#, #a2#"};
		{ 4, 32352, "", "=q4=Naturewarden's Treads", "=ds=#s12#, #a2#"};
		{ 5, 32517, "", "=q4=The Wavemender's Mantle", "=ds=#s3#, #a3#"};
		{ 6, 32346, "", "=q4=Boneweave Girdle", "=ds=#s10#, #a3#"};
		{ 7, 32354, "", "=q4=Crown of Empowered Fate", "=ds=#s1#, #a4#"};
		{ 8, 32345, "", "=q4=Dreadboots of the Legion", "=ds=#s12#, #a4#"};
		{ 16, 32349, "", "=q4=Translucent Spellthread Necklace", "=ds=#s2#"};
		{ 17, 32362, "", "=q4=Pendant of Titans", "=ds=#s2#"};
		{ 18, 32350, "", "=q4=Touch of Inspiration", "=ds=#s15#"};
	...
	AtlasLoot_Data["BTShahraz"] = {
		{ 1, 32367, "", "=q4=Leggings of Devastation", "=ds=#s11#, #a1#"};
		{ 2, 32366, "", "=q4=Shadowmaster's Boots", "=ds=#s12#, #a2#"};
		{ 3, 32365, "", "=q4=Heartshatter Breastplate", "=ds=#s5#, #a4#"};
		{ 4, 32370, "", "=q4=Nadina's Pendant of Purity", "=ds=#s2#"};
		{ 5, 32368, "", "=q4=Tome of the Lightbringer", "=ds=#s16#, #w16#"};
		{ 6, 32369, "", "=q4=Blade of Savagery", "=ds=#h1#, #w10#"};
		{ 16, 31101, "", "=q4=Pauldrons of the Forgotten Conqueror", "=ds=#m23# #e15#"};
	...
	AtlasLoot_Data["BTCouncil"] = {
		{ 1, 32331, "", "=q4=Cloak of the Illidari Council", "=ds=#s4#"};
		{ 2, 32519, "", "=q4=Belt of Divine Guidance", "=ds=#s10#, #a1#"};
		{ 3, 32518, "", "=q4=Veil of Turning Leaves", "=ds=#s3#, #a2#"};
		{ 4, 32376, "", "=q4=Forest Prowler's Helm", "=ds=#s1#, #a3#"};
		{ 5, 32373, "", "=q4=Helm of the Illidari Shatterer", "=ds=#s1#, #a4#"};
		{ 6, 32505, "", "=q4=Madness of the Betrayer", "=ds=#s14#"};
		{ 16, 31098, "", "=q4=Leggings of the Forgotten Conqueror", "=ds=#m23# #e15#"};
	...
	AtlasLoot_Data["BTIllidanStormrage"] = {
		{ 1, 32524, "", "=q4=Shroud of the Highborne", "=ds=#s4#"};
		{ 2, 32525, "", "=q4=Cowl of the Illidari High Lord", "=ds=#s1#, #a1#"};
		{ 3, 32235, "", "=q4=Cursed Vision of Sargeras", "=ds=#s1#, #a2#"};
		{ 4, 32521, "", "=q4=Faceplate of the Impenetrable", "=ds=#s1#, #a4#"};
		{ 5, 32497, "", "=q4=Stormrage Signet Ring", "=ds=#s13#"};
		{ 6, 32483, "", "=q4=The Skull of Gul'dan", "=ds=#s14#"};
		{ 7, 32496, "", "=q4=Memento of Tyrande", "=ds=#s14#"};
		{ 9, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 11, 32837, "", "=q5=Warglaive of Azzinoth", "=ds=#h3#, #w10#, =q1=#m1# =ds=#c9#, #c6#"};
		{ 12, 32838, "", "=q5=Warglaive of Azzinoth", "=ds=#h4#, #w10#, =q1=#m1# =ds=#c9#, #c6#"};
		{ 16, 31089, "", "=q4=Chestguard of the Forgotten Conqueror", "=ds=#m23# #e15#"};
		{ 17, 31091, "", "=q4=Chestguard of the Forgotten Protector", "=ds=#m23# #e15#"};
		{ 18, 31090, "", "=q4=Chestguard of the Forgotten Vanquisher", "=ds=#m23# #e15#"};
		{ 20, 32471, "", "=q4=Shard of Azzinoth", "=ds=#h1#, #w4#"};
		{ 21, 32500, "", "=q4=Crystal Spire of Karabor", "=ds=#h3#, #w6#"};
	...
	AtlasLoot_Data["BTTrash"] = {
		{ 1, 32590, "", "=q4=Nethervoid Cloak", "=ds=#s4#"};
		{ 2, 34012, "", "=q4=Shroud of the Final Stand", "=ds=#s4#"};
		{ 3, 32609, "", "=q4=Boots of the Divine Light", "=ds=#s12#, #a1#"};
		{ 4, 32593, "", "=q4=Treads of the Den Mother", "=ds=#s12#, #a2#"};
		{ 5, 32592, "", "=q4=Chestguard of Relentless Storms", "=ds=#s5#, #a3#"};
		{ 6, 32608, "", "=q4=Pillager's Gauntlets", "=ds=#s9#, #a4#"};
		{ 7, 32606, "", "=q4=Girdle of the Lightbearer", "=ds=#s10#, #a4#"};
		{ 8, 32591, "", "=q4=Choker of Serrated Blades", "=ds=#s2#"};
		{ 9, 32589, "", "=q4=Hellfire-Encased Pendant", "=ds=#s2#"};
		{ 10, 32526, "", "=q4=Band of Devastation", "=ds=#s13#"};
		{ 11, 32528, "", "=q4=Blessed Band of Karabor", "=ds=#s13#"};
		{ 12, 32527, "", "=q4=Ring of Ancient Knowledge", "=ds=#s13#"};
		{ 16, 34009, "", "=q4=Hammer of Judgement", "=ds=#h3#, #w6#"};
		{ 17, 32943, "", "=q4=Swiftsteel Bludgeon", "=ds=#h1#, #w6#"};
		{ 18, 34011, "", "=q4=Illidari Runeshield", "=ds=#w8#"};
		{ 20, 32228, "", "=q4=Empyrean Sapphire", "=ds=#e7#"};
		{ 21, 32231, "", "=q4=Pyrestone", "=ds=#e7#"};
		{ 22, 32229, "", "=q4=Lionseye", "=ds=#e7#"};
		{ 23, 32249, "", "=q4=Seaspray Emerald", "=ds=#e7#"};
		{ 24, 32230, "", "=q4=Shadowsong Amethyst", "=ds=#e7#"};
		{ 25, 32227, "", "=q4=Crimson Spinel", "=ds=#e7#"};
		{ 27, 32428, "", "=q3=Heart of Darkness", "=ds=#e8#"};
		{ 28, 32897, "", "=q2=Mark of the Illidari", "=ds=#m20#"};
	};
	...
	AtlasLoot_Data["CoTHillsbradSkarloc"] = {
		...
		{ 8, 21524, "", "=q2=Red Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
		{ 10, 22927, "", "=q2=Recipe: Ironshield Potion", "=ds=#p1# (365)", "", "1.03%"};
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 18, 30589, "", "=q4=Dazzling Chrysoprase", "=ds=#e7#", "", "0.66%"};
		{ 19, 30591, "", "=q4=Empowered Fire Opal", "=ds=#e7#", "", "0.24%"};
	...
	AtlasLoot_Data["MountHyjalKazrogal"] = {
		{ 1, 30895, "", "=q4=Angelista's Sash", "=ds=#s10#, #a1#"};
		{ 2, 30916, "", "=q4=Leggings of Channeled Elements", "=ds=#s11#, #a1#"};
		{ 3, 30894, "", "=q4=Blue Suede Shoes", "=ds=#s12#, #a1#"};
		{ 4, 30917, "", "=q4=Razorfury Mantle", "=ds=#s3#, #a2#"};
		{ 5, 30914, "", "=q4=Belt of the Crescent Moon", "=ds=#s10#, #a2#"};
		{ 6, 30891, "", "=q4=Black Featherlight Boots", "=ds=#s12#, #a2#"};
		{ 7, 30892, "", "=q4=Beast-tamer's Shoulders", "=ds=#s3#, #a3#"};
		{ 8, 30919, "", "=q4=Valestalker Girdle", "=ds=#s10#, #a3#"};
		{ 9, 30893, "", "=q4=Sun-touched Chain Leggings", "=ds=#s11#, #a3#"};
		{ 10, 30915, "", "=q4=Belt of Seething Fury", "=ds=#s10#, #a4#"};
	...
	AtlasLoot_Data["MountHyjalAzgalor"] = {
		{ 1, 30899, "", "=q4=Don Rodrigo's Poncho", "=ds=#s5#, #a2#"};
		{ 2, 30898, "", "=q4=Shady Dealer's Pantaloons", "=ds=#s11#, #a2#"};
		{ 3, 30900, "", "=q4=Bow-stitched Leggings", "=ds=#s11#, #a3#"};
		{ 4, 30896, "", "=q4=Glory of the Defender", "=ds=#s5#, #a4#"};
		{ 5, 30897, "", "=q4=Girdle of Hope", "=ds=#s10#, #a4#"};
		{ 6, 30901, "", "=q4=Boundless Agony", "=ds=#h1#, #w4#"};
		{ 16, 31092, "", "=q4=Gloves of the Forgotten Conqueror", "=ds=#m23# #e15#"};
	...
	AtlasLoot_Data["MountHyjalArchimonde"] = {
		{ 1, 30913, "", "=q4=Robes of Rhonin", "=ds=#s5#, #a1#"};
		{ 2, 30912, "", "=q4=Leggings of Eternity", "=ds=#s11#, #a1#"};
		{ 3, 30905, "", "=q4=Midnight Chestguard", "=ds=#s5#, #a2#"};
		{ 4, 30907, "", "=q4=Mail of Fevered Pursuit", "=ds=#s5#, #a3#"};
		{ 5, 30904, "", "=q4=Savior's Grasp", "=ds=#s5#, #a4#"};
		{ 6, 30903, "", "=q4=Legguards of Endless Rage", "=ds=#s11#, #a4#"};
		{ 7, 30911, "", "=q4=Scepter of Purification", "=ds=#s15#"};
		{ 9, 30910, "", "=q4=Tempest of Chaos", "=ds=#h3#, #w10#"};
		{ 10, 30902, "", "=q4=Cataclysm's Edge", "=ds=#h2#, #w10#"};
		{ 11, 30908, "", "=q4=Apostle of Argus", "=ds=#w9#"};
		{ 12, 30909, "", "=q4=Antonidas's Aegis of Rapt Concentration", "=ds=#w8#"};
		{ 13, 30906, "", "=q4=Bristleblitz Striker", "=ds=#w2#"};
		{ 16, 31097, "", "=q4=Helm of the Forgotten Conqueror", "=ds=#m23# #e15#"};
	...
	AtlasLoot_Data["MountHyjalTrash"] = {
		...
		{ 16, 32285, "", "=q4=Design: Flashing Crimson Spinel", "=ds=#p12# (375)"};
		{ 17, 32296, "", "=q4=Design: Great Lionseye", "=ds=#p12# (375)"};
		{ 18, 32303, "", "=q4=Design: Inscribed Pyrestone", "=ds=#p12# (375)"};
		{ 19, 32295, "", "=q4=Design: Mystic Lionseye", "=ds=#p12# (375)"};
		{ 20, 32298, "", "=q4=Design: Shifting Shadowsong Amethyst", "=ds=#p12# (375)"};
		{ 21, 32297, "", "=q4=Design: Sovereign Shadowsong Amethyst", "=ds=#p12# (375)"};
		{ 22, 32289, "", "=q4=Design: Stormy Empyrean Sapphire", "=ds=#p12# (375)"};
		{ 23, 32307, "", "=q4=Design: Veiled Pyrestone", "=ds=#p12# (375)"};
	};
	...
	AtlasLoot_Data["CFRSerpentHydross"] = {
		{ 1, 30056, "", "=q4=Robe of Hateful Echoes", "=ds=#s5#, #a1#"};
		{ 2, 32516, "", "=q4=Wraps of Purification", "=ds=#s8#, #a1#"};
		{ 3, 30050, "", "=q4=Boots of the Shifting Nightmare", "=ds=#s12#, #a1#"};
		{ 4, 30055, "", "=q4=Shoulderpads of the Stranger", "=ds=#s3#, #a2#"};
		{ 5, 30047, "", "=q4=Blackfathom Warbands", "=ds=#s8#, #a3#"};
		{ 6, 30054, "", "=q4=Ranger-General's Chestguard", "=ds=#s5#, #a3#"};
		{ 7, 30048, "", "=q4=Brighthelm of Justice", "=ds=#s1#, #a4#"};
		{ 8, 30053, "", "=q4=Pauldrons of the Wardancer", "=ds=#s3#, #a4#"};
		{ 16, 30052, "", "=q4=Ring of Lethality", "=ds=#s13#"};
		{ 17, 33055, "", "=q4=Band of Vile Aggression", "=ds=#s13#"};
		{ 18, 30664, "", "=q4=Living Root of the Wildheart", "=ds=#s14#, =q1=#m1# =ds=#c1#"};
		{ 19, 30629, "", "=q4=Scarab of Displacement", "=ds=#s14#"};
	...
	AtlasLoot_Data["CFRSerpentLurker"] = {
		{ 1, 30064, "", "=q4=Cord of Screaming Terrors", "=ds=#s10#, #a1#"};
		{ 2, 30067, "", "=q4=Velvet Boots of the Guardian", "=ds=#s12#, #a1#"};
		{ 3, 30062, "", "=q4=Grove-Bands of Remulos", "=ds=#s8#, #a2#"};
		{ 4, 30060, "", "=q4=Boots of Effortless Striking", "=ds=#s12#, #a2#"};
		{ 5, 30066, "", "=q4=Tempest-Strider Boots", "=ds=#s12#, #a3#"};
		{ 6, 30065, "", "=q4=Glowing Breastplate of Truth", "=ds=#s5#, #a4#"};
		{ 7, 30057, "", "=q4=Bracers of Eradication", "=ds=#s8#, #a4#"};
		{ 9, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 16, 30059, "", "=q4=Choker of Animalistic Fury", "=ds=#s2#"};
		{ 17, 30061, "", "=q4=Ancestral Ring of Conquest", "=ds=#s13#"};
		{ 18, 33054, "", "=q4=The Seal of Danzalar", "=ds=#s13#"};
	...
	AtlasLoot_Data["CFRSerpentLeotheras"] = {
		{ 1, 30092, "", "=q4=Orca-Hide Boots", "=ds=#s12#, #a2#"};
		{ 2, 30097, "", "=q4=Coral-Barbed Shoulderpads", "=ds=#s3#, #a3#"};
		{ 3, 30091, "", "=q4=True-Aim Stalker Bands", "=ds=#s8#, #a3#"};
		{ 4, 30096, "", "=q4=Girdle of the Invulnerable", "=ds=#s10#, #a4#"};
		{ 5, 30627, "", "=q4=Tsunami Talisman", "=ds=#s14#"};
		{ 6, 30095, "", "=q4=Fang of the Leviathan", "=ds=#h3#, #w10#"};
		{ 16, 30239, "", "=q4=Gloves of the Vanquished Champion", "=ds=#m22# #e15#"};
	...
	AtlasLoot_Data["CFRSerpentKarathress"] = {
		{ 1, 30100, "", "=q4=Soul-Strider Boots", "=ds=#s12#, #a1#"};
		{ 2, 30101, "", "=q4=Bloodsea Brigand's Vest", "=ds=#s5#, #a2#"};
		{ 3, 30099, "", "=q4=Frayed Tether of the Drowned", "=ds=#s2#"};
		{ 4, 30663, "", "=q4=Fathom-Brooch of the Tidewalker", "=ds=#s14#, =q1=#m1# =ds=#c7#"};
		{ 5, 30626, "", "=q4=Sextant of Unstable Currents", "=ds=#s14#"};
		{ 6, 30090, "", "=q4=World Breaker", "=ds=#h2#, #w6#"};
		{ 16, 30245, "", "=q4=Leggings of the Vanquished Champion", "=ds=#m22# #e15#"};
	...
	AtlasLoot_Data["CFRSerpentMorogrim"] = {
		{ 1, 30098, "", "=q4=Razor-Scale Battlecloak", "=ds=#s4#"};
		{ 2, 30079, "", "=q4=Illidari Shoulderpads", "=ds=#s3#, #a1#"};
		{ 3, 30075, "", "=q4=Gnarled Chestpiece of the Ancients", "=ds=#s5#, #a2#"};
		{ 4, 30085, "", "=q4=Mantle of the Tireless Tracker", "=ds=#s3#, #a3#"};
		{ 5, 30068, "", "=q4=Girdle of the Tidal Call", "=ds=#s10#, #a3#"};
		{ 6, 30084, "", "=q4=Pauldrons of the Argent Sentinel", "=ds=#s3#, #a4#"};
		{ 7, 30081, "", "=q4=Warboots of Obliteration", "=ds=#s12#, #a4#"};
		{ 9, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 16, 30008, "", "=q4=Pendant of the Lost Ages", "=ds=#s2#"};
		{ 17, 30083, "", "=q4=Ring of Sundered Souls", "=ds=#s13#"};
		{ 18, 33058, "", "=q4=Band of the Vigilant", "=ds=#s13#"};
	...
	AtlasLoot_Data["CFRSerpentVashj"] = {
		{ 1, 30107, "", "=q4=Vestments of the Sea-Witch", "=ds=#s5#, #a1#"};
		{ 2, 30111, "", "=q4=Runetotem's Mantle", "=ds=#s3#, #a2#"};
		{ 3, 30106, "", "=q4=Belt of One-Hundred Deaths", "=ds=#s10#, #a2#"};
		{ 4, 30104, "", "=q4=Cobra-Lash Boots", "=ds=#s12#, #a3#"};
		{ 5, 30102, "", "=q4=Krakken-Heart Breastplate", "=ds=#s5#, #a4#"};
		{ 6, 30112, "", "=q4=Glorious Gauntlets of Crestfall", "=ds=#s9#, #a4#"};
		{ 7, 30109, "", "=q4=Ring of Endless Coils", "=ds=#s13#"};
		{ 8, 30110, "", "=q4=Coral Band of the Revived", "=ds=#s13#"};
		{ 9, 30621, "", "=q4=Prism of Inner Calm", "=ds=#s14#"};
		{ 10, 30103, "", "=q4=Fang of Vashj", "=ds=#h1#, #w4#"};
		{ 11, 30108, "", "=q4=Lightfathom Scepter", "=ds=#h3#, #w6#"};
		{ 12, 30105, "", "=q4=Serpent Spine Longbow", "=ds=#w2#"};
		{ 16, 30242, "", "=q4=Helm of the Vanquished Champion", "=ds=#m22# #e15#"};
		{ 17, 30243, "", "=q4=Helm of the Vanquished Defender", "=ds=#m22# #e15#"};
	...
	AtlasLoot_Data["CFRSerpentTrash"] = {
		{ 1, 30027, "", "=q4=Boots of Courage Unending", "=ds=#s12#, #a4#"};
		{ 2, 30022, "", "=q4=Pendant of the Perilous", "=ds=#s2#"};
		{ 3, 30620, "", "=q4=Spyglass of the Hidden Fleet", "=ds=#s14#"};
		{ 4, 30023, "", "=q4=Totem of the Maelstrom", "=ds=#s16#, #w15#"};
		{ 5, 30021, "", "=q4=Wildfury Greatstaff", "=ds=#w9#"};
		{ 6, 30025, "", "=q4=Serpentshrine Shuriken", "=ds=#w11#"};
		{ 8, 30324, "", "=q4=Plans: Red Havoc Boots", "=ds=#p2# (375)"};
		{ 9, 30322, "", "=q4=Plans: Red Belt of Battle", "=ds=#p2# (375)"};
		{ 10, 30323, "", "=q4=Plans: Boots of the Protector", "=ds=#p2# (375)"};
		{ 11, 30321, "", "=q4=Plans: Belt of the Guardian", "=ds=#p2# (375)"};
		{ 12, 30280, "", "=q4=Pattern: Belt of Blasting", "=ds=#p8# (375)"};
		{ 13, 30282, "", "=q4=Pattern: Boots of Blasting", "=ds=#p8# (375)"};
		{ 14, 30283, "", "=q4=Pattern: Boots of the Long Road", "=ds=#p8# (375)"};
		{ 15, 30281, "", "=q4=Pattern: Belt of the Long Road", "=ds=#p8# (375)"};
		{ 16, 30308, "", "=q4=Pattern: Hurricane Boots", "=ds=#p7# (375)"};
		{ 17, 30304, "", "=q4=Pattern: Monsoon Belt", "=ds=#p7# (375)"};
		{ 18, 30305, "", "=q4=Pattern: Boots of Natural Grace", "=ds=#p7# (375)"};
		{ 19, 30307, "", "=q4=Pattern: Boots of the Crimson Hawk", "=ds=#p7# (375)"};
		{ 20, 30306, "", "=q4=Pattern: Boots of Utter Darkness", "=ds=#p7# (375)"};
		{ 21, 30301, "", "=q4=Pattern: Belt of Natural Power", "=ds=#p7# (375)"};
		{ 22, 30303, "", "=q4=Pattern: Belt of the Black Eagle", "=ds=#p7# (375)"};
		{ 23, 30302, "", "=q4=Pattern: Belt of Deep Shadow", "=ds=#p7# (375)"};
		{ 25, 30183, "", "=q4=Nether Vortex", "=ds=#e8#"};
		{ 27, 32897, "", "=q2=Mark of the Illidari", "=ds=#m20#"};
	};
	...
	AtlasLoot_Data["HCHallsNethekurse"] = {
		...
		{ 9, 21525, "", "=q2=Green Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
		{ 11, 23735, "", "=q1=Grand Warlock's Amulet", "=ds=#m3#", "", "100%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["SMTFireheart"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 34702, "", "=q3=Cloak of Swift Mending", "=ds=#s4#"};
		{ 3, 34697, "", "=q3=Bindings of Raging Fire", "=ds=#s8#, #a1#"};
		{ 4, 34701, "", "=q3=Leggings of the Betrayed", "=ds=#s11#, #a2#"};
		{ 5, 34698, "", "=q3=Bracers of the Forest Stalker", "=ds=#s8#, #a3#"};
		{ 6, 34700, "", "=q3=Gauntlets of Divine Blessings", "=ds=#s9#, #a4#"};
		{ 7, 34699, "", "=q3=Sun-forged Cleaver", "=ds=#h1#, #w1#"};
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 18, 34602, "", "=q4=Eversong Cuffs", "=ds=#s8#, #a2#"};
		{ 19, 34601, "", "=q4=Shoulderplates of Everlasting Pain", "=ds=#s3#, #a4#"};
	...
	AtlasLoot_Data["SMTVexallus"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 34708, "", "=q3=Cloak of the Coming Night", "=ds=#s4#"};
		{ 3, 34705, "", "=q3=Bracers of Divine Infusion", "=ds=#s8#, #a1#"};
		{ 4, 34707, "", "=q3=Boots of Resuscitation", "=ds=#s12#, #a2#"};
		{ 5, 34704, "", "=q3=Band of Arcane Alacrity", "=ds=#s13#"};
		{ 6, 34706, "", "=q3=Band of Determination", "=ds=#s13#"};
		{ 7, 34703, "", "=q3=Latro's Dancing Blade", "=ds=#h1#, #w10#"};
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 18, 34607, "", "=q4=Fel-tinged Mantle", "=ds=#s3#, #a1#"};
		{ 19, 34605, "", "=q4=Breastplate of Fierce Survival", "=ds=#s5#, #a4#"};
	...
	AtlasLoot_Data["SMTDelrissa"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 2, 34792, "", "=q3=Cloak of the Betrayed", "=ds=#s4#"};
		{ 3, 34788, "", "=q3=Duskhallow Mantle", "=ds=#s3#, #a1#"};
		{ 4, 34791, "", "=q3=Gauntlets of the Tranquil Waves", "=ds=#s9#, #a3#"};
		{ 5, 34789, "", "=q3=Bracers of Slaughter", "=ds=#s8#, #a4#"};
		{ 6, 34790, "", "=q3=Battle-mace of the High Priestess", "=ds=#h3#, #w6#"};
		{ 7, 34783, "", "=q3=Nightstrike", "=ds=#w11#"};
		{ 9, 35756, "", "=q3=Formula: Enchant Cloak - Steelweave", "=ds=#p4# (375)"};
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 18, 34473, "", "=q4=Commendation of Kael'thas", "=ds=#s14#"};
		{ 19, 34472, "", "=q4=Shard of Contempt", "=ds=#s14#"};
	...
	AtlasLoot_Data["SMTKaelthas"] = {
		{ 1, 34810, "", "=q4=Cloak of Blade Turning", "=ds=#s4#"};
		{ 2, 34808, "", "=q4=Gloves of Arcane Acuity", "=ds=#s9#, #a1#"};
		{ 3, 34809, "", "=q4=Sunrage Treads", "=ds=#s12#, #a2#"};
		{ 4, 34799, "", "=q4=Hauberk of the War Bringer", "=ds=#s5#, #a3#"};
		{ 5, 34807, "", "=q4=Sunstrider Warboots", "=ds=#s12#, #a4#"};
		{ 6, 34625, "", "=q4=Kharmaa's Ring of Fate", "=ds=#s13#"};
		{ 8, 34157, "", "=q1=Head of Kael'thas", "=ds=#m3#"};
		{ 16, 34793, "", "=q3=Cord of Reconstruction", "=ds=#s10#, #a1#"};
		{ 17, 34796, "", "=q3=Robes of Summer Flame", "=ds=#s5#, #a2#"};
		{ 18, 34795, "", "=q3=Helm of Sanctification", "=ds=#s1#, #a4#"};
		{ 19, 34798, "", "=q3=Band of Celerity", "=ds=#s13#"};
	...
	AtlasLoot_Data["SMTKaelthasHEROIC"] = {
		{ 1, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 2, 34610, "", "=q4=Scarlet Sin'dorei Robes", "=ds=#s5#, #a1#"};
		{ 3, 34613, "", "=q4=Shoulderpads of the Silvermoon Retainer", "=ds=#s3#, #a2#"};
		{ 4, 34614, "", "=q4=Tunic of the Ranger Lord", "=ds=#s5#, #a3#"};
		{ 5, 34615, "", "=q4=Netherforce Chestplate", "=ds=#s5#, #a4#"};
		{ 6, 34612, "", "=q4=Greaves of the Penitent Knight", "=ds=#s12#, #a4#"};
		{ 8, 34160, "", "=q1=The Signet Ring of Prince Kael'thas", "=ds=#m3#"};
		{ 16, 34609, "", "=q4=Quickening Blade of the Prince", "=ds=#h1#, #w10#"};
		{ 17, 34616, "", "=q4=Breeching Comet", "=ds=#h1#, #w1#"};
	...
	AtlasLoot_Data["SMTTrash"] = {
		{ 1, 35516, "", "=q3=Sun Touched Satchel", "=ds=#e1# #m15#"};
	};
	...
	AtlasLoot_Data["SPBrutallus"] = {
		{ 1, 34181, "", "=q4=Leggings of Calamity", "=ds=#s11#, #a1#"};
		{ 2, 34180, "", "=q4=Felfury Legplates", "=ds=#s11#, #a4#"};
		{ 3, 34381, "", "=q4=Felstrength Legplates", "=ds=#m29#"};
		{ 4, 34178, "", "=q4=Collar of the Pit Lord", "=ds=#s2#"};
		{ 5, 34177, "", "=q4=Clutch of Demise", "=ds=#s2#"};
		{ 6, 34179, "", "=q4=Heart of the Pit", "=ds=#s15#"};
		{ 7, 34176, "", "=q4=Reign of Misery", "=ds=#h3#, #w6#"};
		{ 16, 34853, "", "=q4=Belt of the Forgotten Conqueror", "=ds=#m23# #e15#"};
	...
	AtlasLoot_Data["SPFelmyst"] = {
		{ 1, 34352, "", "=q4=Borderland Fortress Grips", "=ds=#s9#, #a4#"};
		{ 2, 34188, "", "=q4=Leggings of the Immortal Night", "=ds=#s11#, #a2#"};
		{ 3, 34385, "", "=q4=Leggings of the Immortal Beast", "=ds=#m29#"};
		{ 4, 34186, "", "=q4=Chain Links of the Tumultuous Storm", "=ds=#s11#, #a3#"};
		{ 5, 34383, "", "=q4=Kilt of Spiritual Reconstruction", "=ds=#m29#"};
		{ 6, 34184, "", "=q4=Brooch of the Highborne", "=ds=#s2#"};
		{ 7, 34185, "", "=q4=Sword Breaker's Bulwark", "=ds=#w8#"};
		{ 8, 34182, "", "=q4=Grand Magister's Staff of Torrents", "=ds=#w9#"};
		{ 16, 34856, "", "=q4=Boots of the Forgotten Conqueror", "=ds=#m23# #e15#"};
	...
	AtlasLoot_Data["SPEredarTwins"] = {
		{ 1, 34205, "", "=q4=Shroud of Redeemed Souls", "=ds=#s4#"};
		{ 2, 34190, "", "=q4=Crimson Paragon's Cover", "=ds=#s4#"};
		{ 3, 34210, "", "=q4=Amice of the Convoker", "=ds=#s3#, #a1#"};
		{ 4, 34202, "", "=q4=Shawl of Wonderment", "=ds=#s3#, #a1#"};
		{ 5, 34393, "", "=q4=Shoulderpads of Knowledge's Pursuit", "=ds=#m29#"};
		{ 6, 34209, "", "=q4=Spaulders of Reclamation", "=ds=#s3#, #a2#"};
		{ 7, 34391, "", "=q4=Spaulders of Devastation", "=ds=#m29#"};
		{ 8, 34195, "", "=q4=Shoulderpads of Vehemence", "=ds=#s3#, #a2#"};
		{ 9, 34392, "", "=q4=Demontooth Shoulderpads", "=ds=#m29#"};
		{ 10, 34194, "", "=q4=Mantle of the Golden Forest", "=ds=#s3#, #a3#"};
		{ 11, 34208, "", "=q4=Equilibrium Epaulets", "=ds=#s3#, #a3#"};
		{ 12, 34390, "", "=q4=Erupting Epaulets", "=ds=#m29#"};
		{ 13, 34192, "", "=q4=Pauldrons of Perseverance", "=ds=#s3#, #a4#"};
		{ 14, 34388, "", "=q4=Pauldrons of Berserking", "=ds=#m29#"};
		{ 16, 34193, "", "=q4=Spaulders of the Thalassian Savior", "=ds=#s3#, #a4#"};
		{ 17, 34389, "", "=q4=Spaulders of the Thalassian Defender", "=ds=#m29#"};
		{ 18, 35290, "", "=q4=Sin'dorei Pendant of Conquest", "=ds=#s2#"};
		{ 19, 35291, "", "=q4=Sin'dorei Pendant of Salvation", "=ds=#s2#"};
		{ 20, 35292, "", "=q4=Sin'dorei Pendant of Triumph", "=ds=#s2#"};
		{ 21, 34204, "", "=q4=Amulet of Unfettered Magics", "=ds=#s2#"};
		{ 22, 34189, "", "=q4=Band of Ruinous Delight", "=ds=#s13#"};
		{ 23, 34206, "", "=q4=Book of Highborne Hymns", "=ds=#s15#"};
		{ 24, 34197, "", "=q4=Shiv of Exsanguination", "=ds=#h1#, #w4#"};
		{ 25, 34199, "", "=q4=Archon's Gavel", "=ds=#h3#, #w6#"};
		{ 26, 34203, "", "=q4=Grip of Mannoroth", "=ds=#h4#, #w13#"};
	...
	AtlasLoot_Data["SPMuru"] = {
		{ 1, 34232, "", "=q4=Fel Conquerer Raiments", "=ds=#s5#, #a1#"};
		{ 2, 34233, "", "=q4=Robes of Faltered Light", "=ds=#s5#, #a1#"};
		{ 3, 34399, "", "=q4=Robes of Ghostly Hatred", "=ds=#m29#"};
		{ 4, 34212, "", "=q4=Sunglow Vest", "=ds=#s5#, #a2#"};
		{ 5, 34398, "", "=q4=Utopian Tunic of Elune", "=ds=#m29#"};
		{ 6, 34211, "", "=q4=Harness of Carnal Instinct", "=ds=#s5#, #a2#"};
		{ 7, 34397, "", "=q4=Bladed Chaos Tunic", "=ds=#m29#"};
		{ 8, 34234, "", "=q4=Shadowed Gauntlets of Paroxysm", "=ds=#s9#, #a2#"};
		{ 9, 34408, "", "=q4=Gloves of the Forest Drifter", "=ds=#m29#"};
		{ 10, 34229, "", "=q4=Garments of Serene Shores", "=ds=#s5#, #a3#"};
		{ 11, 34396, "", "=q4=Garments of Crashing Shores", "=ds=#m29#"};
		{ 12, 34228, "", "=q4=Vicious Hawkstrider Hauberk", "=ds=#s5#, #a3#"};
		{ 13, 34215, "", "=q4=Warharness of Reckless Fury", "=ds=#s5#, #a4#"};
		{ 14, 34394, "", "=q4=Breastplate of Agony's Aversion", "=ds=#m29#"};
		{ 15, 34240, "", "=q4=Gauntlets of the Soothed Soul", "=ds=#s9#, #a4#"};
		{ 16, 34216, "", "=q4=Heroic Judicator's Chestguard", "=ds=#s5#, #a4#"};
		{ 17, 34395, "", "=q4=Noble Judicator's Chestguard", "=ds=#m29#"};
		{ 18, 34213, "", "=q4=Ring of Hardened Resolve", "=ds=#s13#"};
		{ 19, 34230, "", "=q4=Ring of Omnipotence", "=ds=#s13#"};
		{ 20, 35282, "", "=q4=Sin'dorei Band of Dominance", "=ds=#s13#"};
		{ 21, 35283, "", "=q4=Sin'dorei Band of Salvation", "=ds=#s13#"};
		{ 22, 35284, "", "=q4=Sin'dorei Band of Triumph", "=ds=#s13#"};
		{ 23, 34427, "", "=q4=Blackened Naaru Sliver", "=ds=#s14#"};
		{ 24, 34430, "", "=q4=Glimmering Naaru Sliver", "=ds=#s14#"};
		{ 25, 34429, "", "=q4=Shifting Naaru Sliver", "=ds=#s14#"};
		{ 26, 34428, "", "=q4=Steely Naaru Sliver", "=ds=#s14#"};
	...
	AtlasLoot_Data["SPKiljaeden"] = {
		{ 1, 34241, "", "=q4=Cloak of Unforgivable Sin", "=ds=#s4#"};
		{ 2, 34242, "", "=q4=Tattered Cape of Antonidas", "=ds=#s4#"};
		{ 3, 34339, "", "=q4=Cowl of Light's Purity", "=ds=#s1#, #a1#"};
		{ 4, 34405, "", "=q4=Helm of Arcane Purity", "=ds=#m29#"};
		{ 5, 34340, "", "=q4=Dark Conjuror's Collar", "=ds=#s1#, #a1#"};
		{ 6, 34342, "", "=q4=Handguards of the Dawn", "=ds=#s9#, #a1#"};
		{ 7, 34406, "", "=q4=Gloves of Tyri's Power", "=ds=#m29#"};
		{ 8, 34344, "", "=q4=Handguards of the Defiled Worlds", "=ds=#s9#, #a1#"};
		{ 9, 34244, "", "=q4=Duplicitous Guise", "=ds=#s1#, #a2#"};
		{ 10, 34404, "", "=q4=Mask of the Furry Hunter", "=ds=#m29#"};
		{ 11, 34245, "", "=q4=Cover of Ursol the Wise", "=ds=#s1#, #a2#"};
		{ 12, 34403, "", "=q4=Cover of Ursoc the Mighty", "=ds=#m29#"};
		{ 13, 34333, "", "=q4=Coif of Alleria", "=ds=#s1#, #a3#"};
		{ 14, 34332, "", "=q4=Cowl of Gul'dan", "=ds=#s1#, #a3#"};
		{ 15, 34402, "", "=q4=Shroud of Chieftain Ner'zhul", "=ds=#m29#"};
		{ 16, 34343, "", "=q4=Thalassian Ranger Gauntlets", "=ds=#s9#, #a3#"};
		{ 17, 34243, "", "=q4=Helm of Burning Righteousness", "=ds=#s1#, #a4#"};
		{ 18, 34401, "", "=q4=Helm of Uther's Resolve", "=ds=#m29#"};
		{ 19, 34345, "", "=q4=Crown of Anasterian", "=ds=#s1#, #a4#"};
		{ 20, 34400, "", "=q4=Crown of Dath'Remar", "=ds=#m29#"};
		{ 21, 34341, "", "=q4=Borderland Paingrips", "=ds=#s9#, #a4#"};
		{ 23, 34334, "", "=q5=Thori'dal, the Stars' Fury", "=ds=#w2#"};
		{ 25, 34329, "", "=q4=Crux of the Apocalypse", "=ds=#h1#, #w4#"};
		{ 26, 34247, "", "=q4=Apolyon, the Soul-Render", "=ds=#h2#, #w10#"};
		{ 27, 34335, "", "=q4=Hammer of Sanctification", "=ds=#h3#, #w6#"};
	...
	AtlasLoot_Data["SPTrash"] = {
		{ 1, 34351, "", "=q4=Tranquil Majesty Wraps", "=ds=#s9#, #a2#"};
		{ 2, 34407, "", "=q4=Tranquil Moonlight Wraps", "=ds=#m29#"};
		{ 3, 34350, "", "=q4=Gauntlets of the Ancient Shadowmoon", "=ds=#s9#, #a3#"};
		{ 4, 34409, "", "=q4=Gauntlets of the Ancient Frostwolf", "=ds=#m29#"};
		{ 5, 35733, "", "=q4=Ring of Harmonic Beauty", "=ds=#s13#"};
		{ 6, 34183, "", "=q4=Shivering Felspine", "=ds=#h2#, #w7#"};
		{ 7, 34346, "", "=q4=Mounting Vengeance", "=ds=#h4#, #w13#"};
		{ 8, 34349, "", "=q4=Blade of Life's Inevitability", "=ds=#w11#"};
		{ 9, 34348, "", "=q4=Wand of Cleansing Light", "=ds=#w12#"};
		{ 10, 34347, "", "=q4=Wand of the Demonsoul", "=ds=#w12#"};
		{ 12, 35273, "", "=q3=Study of Advanced Smelting", "=ds=#p23# (375)"};
		{ 14, 34664, "", "=q3=Sunmote", "=ds=#m20#"};
		{ 16, 32228, "", "=q4=Empyrean Sapphire", "=ds=#e7#"};
		{ 17, 32231, "", "=q4=Pyrestone", "=ds=#e7#"};
		{ 18, 32229, "", "=q4=Lionseye", "=ds=#e7#"};
		{ 19, 32249, "", "=q4=Seaspray Emerald", "=ds=#e7#"};
		{ 20, 32230, "", "=q4=Shadowsong Amethyst", "=ds=#e7#"};
		{ 21, 32227, "", "=q4=Crimson Spinel", "=ds=#e7#"};
		{ 23, 35208, "", "=q4=Plans: Sunblessed Gauntlets", "=ds=#p2# (365)"};
		{ 24, 35210, "", "=q4=Plans: Sunblessed Breastplate", "=ds=#p2# (365)"};
		{ 25, 35209, "", "=q4=Plans: Hard Khorium Battlefists", "=ds=#p2# (365)"};
		{ 26, 35211, "", "=q4=Plans: Hard Khorium Battleplate", "=ds=#p2# (365)"};
	};
	...
	AtlasLoot_Data["TKBotFreywinn"] = {
		...
		{ 9, 21524, "", "=q2=Red Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
		{ 11, 31744, "", "=q1=Botanist's Field Guide", "=ds=#m3#", "", "100%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 18, 30574, "", "=q4=Brutal Tanzanite", "=ds=#e7#", "", "8.00%"};
		{ 19, 30572, "", "=q4=Imperial Tanzanite", "=ds=#e7#", "", "8.00%"};
	...
	AtlasLoot_Data["TKMechSepethrea"] = {
		...
		{ 7, 21524, "", "=q2=Red Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
		{ 9, 22920, "", "=q2=Recipe: Major Fire Protection Potion", "=ds=#p1# (360) =q1=#n93#"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 18, 30565, "", "=q4=Assassin's Fire Opal", "=ds=#e7#", "", "18.72%"};
		{ 19, 30566, "", "=q4=Defender's Tanzanite", "=ds=#e7#", "", "8.87%"};
	...
	AtlasLoot_Data["TKEyeAlar"] = {
		{ 1, 29925, "", "=q4=Phoenix-Wing Cloak", "=ds=#s4#"};
		{ 2, 29918, "", "=q4=Mindstorm Wristbands", "=ds=#s8#, #a1#"};
		{ 3, 29947, "", "=q4=Gloves of the Searing Grip", "=ds=#s9#, #a2#"};
		{ 4, 29921, "", "=q4=Fire Crest Breastplate", "=ds=#s5#, #a3#"};
		{ 5, 29922, "", "=q4=Band of Al'Ar", "=ds=#s13#"};
		{ 6, 29920, "", "=q4=Phoenix-Ring of Rebirth", "=ds=#s13#"};
		{ 7, 30448, "", "=q4=Talon of Al'ar", "=ds=#s14#, =q1=#m1# =ds=#c2#"};
		{ 8, 30447, "", "=q4=Tome of Fiery Redemption", "=ds=#s14#, =q1=#m1# =ds=#c4#"};
		{ 9, 29923, "", "=q4=Talisman of the Sun King", "=ds=#s15#"};
		{ 16, 32944, "", "=q4=Talon of the Phoenix", "=ds=#h3#, #w13#"};
		{ 17, 29948, "", "=q4=Claw of the Phoenix", "=ds=#h4#, #w13#"};
	...
	AtlasLoot_Data["TKEyeVoidReaver"] = {
		{ 1, 29986, "", "=q4=Cowl of the Grand Engineer", "=ds=#s1#, #a1#"};
		{ 2, 29984, "", "=q4=Girdle of Zaetar", "=ds=#s10#, #a2#"};
		{ 3, 29985, "", "=q4=Void Reaver Greaves", "=ds=#s11#, #a3#"};
		{ 4, 29983, "", "=q4=Fel-Steel Warhelm", "=ds=#s1#, #a4#"};
		{ 5, 32515, "", "=q4=Wristgaurds of Determination", "=ds=#s8#, #a4#"};
		{ 6, 30619, "", "=q4=Fel Reaver's Piston", "=ds=#s14#"};
		{ 7, 30450, "", "=q4=Warp-Spring Coil", "=ds=#s14#, =q1=#m1# =ds=#c6#"};
		{ 16, 30248, "", "=q4=Pauldrons of the Vanquished Champion", "=ds=#m22# #e15#"};
	...
	AtlasLoot_Data["TKEyeSolarian"] = {
		{ 1, 29977, "", "=q4=Star-Soul Breeches", "=ds=#s11#, #a1#"};
		{ 2, 29972, "", "=q4=Trousers of the Astromancer", "=ds=#s11#, #a1#"};
		{ 3, 29966, "", "=q4=Vambraces of Ending", "=ds=#s8#, #a2#"};
		{ 4, 29976, "", "=q4=Worldstorm Gauntlets", "=ds=#s9#, #a3#"};
		{ 5, 29951, "", "=q4=Star-Strider Boots", "=ds=#s12#, #a3#"};
		{ 6, 29965, "", "=q4=Girdle of the Righteous Path", "=ds=#s10#, #a4#"};
		{ 7, 29950, "", "=q4=Greaves of the Bloodwarder", "=ds=#s11#, #a4#"};
		{ 8, 32267, "", "=q4=Boots of the Resilient", "=ds=#s12#, #a4#"};
		{ 16, 30446, "", "=q4=Solarian's Sapphire", "=ds=#s14#, =q1=#m1# =ds=#c9#"};
		{ 17, 30449, "", "=q4=Void Star Talisman", "=ds=#s14#, =q1=#m1# =ds=#c8#"};
		{ 18, 29962, "", "=q4=Heartrazor", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["TKEyeKaelthas"] = {
		{ 1, 29992, "", "=q4=Royal Cloak of the Sunstriders", "=ds=#s4#"};
		{ 2, 29989, "", "=q4=Sunshower Light Cloak", "=ds=#s4#"};
		{ 3, 29994, "", "=q4=Thalassian Wildercloak", "=ds=#s4#"};
		{ 4, 29990, "", "=q4=Crown of the Sun", "=ds=#s1#, #a1#"};
		{ 5, 29987, "", "=q4=Gauntlets of the Sun-King", "=ds=#s9#, #a1#"};
		{ 6, 29995, "", "=q4=Leggings of Murderous Intent", "=ds=#s11#, #a2#"};
		{ 7, 29991, "", "=q4=Sunhawk Leggings", "=ds=#s11#, #a3#"};
		{ 8, 29998, "", "=q4=Royal Gauntlets of Silvermoon", "=ds=#s9#, #a4#"};
		{ 9, 29997, "", "=q4=Band of the Ranger-General", "=ds=#s13#"};
		{ 10, 29993, "", "=q4=Twinblade of the Phoenix", "=ds=#h2#, #w10#"};
		{ 11, 29996, "", "=q4=Rod of the Sun King", "=ds=#h1#, #w6#"};
		{ 12, 29988, "", "=q4=The Nexus Key", "=ds=#w9#"};
		{ 14, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 16, 30236, "", "=q4=Chestguard of the Vanquished Champion", "=ds=#m22# #e15#"};
		{ 17, 30237, "", "=q4=Chestguard of the Vanquished Defender", "=ds=#m22# #e15#"};
		{ 18, 30238, "", "=q4=Chestguard of the Vanquished Hero", "=ds=#m22# #e15#"};
		{ 20, 32458, "", "=q4=Ashes of Al'ar", "=ds=#e12#"};
	...
	AtlasLoot_Data["TKEyeTrash"] = {
		{ 1, 30024, "", "=q4=Mantle of the Elven Kings", "=ds=#s3#, #a1#"};
		{ 2, 30020, "", "=q4=Fire-Cord of the Magus", "=ds=#s10#, #a1#"};
		{ 3, 30029, "", "=q4=Bark-Gloves of Ancient Wisdom", "=ds=#s9#, #a2#"};
		{ 4, 30026, "", "=q4=Bands of the Celestial Archer", "=ds=#s8#, #a3#"};
		{ 5, 30030, "", "=q4=Girdle of Fallen Stars", "=ds=#s10#, #a3#"};
		{ 6, 30028, "", "=q4=Seventh Ring of the Tirisfalen", "=ds=#s13#"};
		{ 8, 30324, "", "=q4=Plans: Red Havoc Boots", "=ds=#p2# (375)"};
		{ 9, 30322, "", "=q4=Plans: Red Belt of Battle", "=ds=#p2# (375)"};
		{ 10, 30323, "", "=q4=Plans: Boots of the Protector", "=ds=#p2# (375)"};
		{ 11, 30321, "", "=q4=Plans: Belt of the Guardian", "=ds=#p2# (375)"};
	...
	AtlasLoot_Data["ZANalorakk"] = {
		{ 1, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 2, 33203, "", "=q4=Robes of Heavenly Purpose", "=ds=#s5#, #a1#"};
		{ 3, 33285, "", "=q4=Fury of the Ursine", "=ds=#s8#, #a1#"};
		{ 4, 33211, "", "=q4=Bladeangel's Money Belt", "=ds=#s10#, #a2#"};
		{ 5, 33206, "", "=q4=Pauldrons of Primal Fury", "=ds=#s3#, #a3#"};
		{ 6, 33327, "", "=q4=Mask of Introspection", "=ds=#s1#, #a4#"};
	...
	AtlasLoot_Data["ZAAkilZon"] = {
		{ 1, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 2, 33286, "", "=q4=Mojo-mender's Mask", "=ds=#s1#, #a3#"};
		{ 3, 33215, "", "=q4=Bloodstained Elven Battlevest", "=ds=#s5#, #a4#"};
		{ 4, 33216, "", "=q4=Chestguard of Hidden Purpose", "=ds=#s5#, #a4#"};
		{ 5, 33281, "", "=q4=Brooch of Nature's Mercy", "=ds=#s2#"};
		{ 6, 33293, "", "=q4=Signet of Ancient Magics", "=ds=#s13#"};
	...
	AtlasLoot_Data["ZAJanAlai"] = {
		{ 1, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 2, 33357, "", "=q4=Footpads of Madness", "=ds=#s12#, #a1#"};
		{ 3, 33356, "", "=q4=Helm of Natural Regeneration", "=ds=#s1#, #a2#"};
		{ 4, 33329, "", "=q4=Shadowtooth Trollskin Cuirass", "=ds=#s5#, #a2#"};
		{ 5, 33328, "", "=q4=Arrow-fall Chestguard", "=ds=#s5#, #a3#"};
		{ 6, 33354, "", "=q4=Wub's Cursed Hexblade", "=ds=#h3#, #w4#"};
	...
	AtlasLoot_Data["ZAHalazzi"] = {
		{ 1, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 2, 33317, "", "=q4=Robe of Departed Spirits", "=ds=#s5#, #a1#"};
		{ 3, 33300, "", "=q4=Shoulderpads of Dancing Blades", "=ds=#s3#, #a2#"};
		{ 4, 33322, "", "=q4=Shimmer-pelt Vest", "=ds=#s5#, #a2#"};
		{ 5, 33533, "", "=q4=Avalanche Leggings", "=ds=#s11#, #a3#"};
		{ 6, 33299, "", "=q4=Spaulders of the Advocate", "=ds=#s3#, #a4#"};
	...
	AtlasLoot_Data["ZAMalacrass"] = {
		{ 1, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 2, 33592, "", "=q4=Cloak of Ancient Rituals", "=ds=#s4#"};
		{ 3, 33453, "", "=q4=Hood of Hexing", "=ds=#s1#, #a1#"};
		{ 4, 33463, "", "=q4=Hood of the Third Eye", "=ds=#s1#, #a1#"};
		{ 5, 33432, "", "=q4=Coif of the Jungle Stalker", "=ds=#s1#, #a3#"};
		{ 6, 33464, "", "=q4=Hex Lord's Voodoo Pauldrons", "=ds=#s3#, #a3#"};
		{ 7, 33421, "", "=q4=Battleworn Tuskguard", "=ds=#s1#, #a4#"};
		{ 8, 33446, "", "=q4=Girdle of Stromgarde's Hope", "=ds=#s10#, #a4#"};
		{ 10, 33307, "", "=q3=Formula: Enchant Weapon - Executioner", "=ds=#p4# (375)"};
		{ 16, 33829, "", "=q4=Hex Shrunken Head", "=ds=#s14#"};
		{ 17, 34029, "", "=q4=Tiny Voodoo Mask", "=ds=#s14#"};
		{ 18, 33828, "", "=q4=Tome of Diabolic Remedy", "=ds=#s14#"};
		{ 19, 33389, "", "=q4=Dagger of Bad Mojo", "=ds=#h1#, #w4#"};
	...
	AtlasLoot_Data["ZAZuljin"] = {
		{ 1, 29434, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
		{ 2, 33471, "", "=q4=Two-toed Sandals", "=ds=#s12#, #a1#"};
		{ 3, 33479, "", "=q4=Grimgin Faceguard", "=ds=#s1#, #a2#"};
		{ 4, 33469, "", "=q4=Hauberk of the Empire's Champion", "=ds=#s5#, #a3#"};
		{ 5, 33473, "", "=q4=Chestguard of the Warlord", "=ds=#s5#, #a4#"};
		{ 6, 33466, "", "=q4=Loop of Cursed Bones", "=ds=#s2#"};
		{ 7, 33830, "", "=q4=Ancient Aqir Artifact", "=ds=#s14#"};
		{ 8, 33831, "", "=q4=Berserker's Call", "=ds=#s14#"};
		{ 10, 33307, "", "=q3=Formula: Enchant Weapon - Executioner", "=ds=#p4# (375)"};
		{ 16, 33467, "", "=q4=Blade of Twisted Visions", "=ds=#h3#, #w10#"};
		{ 17, 33478, "", "=q4=Jin'rohk, The Great Apocalypse", "=ds=#h2#, #w10#"};
		{ 18, 33476, "", "=q4=Cleaver of the Unforgiving", "=ds=#h1#, #w1#"};
	...
	AtlasLoot_Data["ZATimedChest"] = {
		...
		{ 2, 33590, "", "=q4=Cloak of Fiends", "=ds=#s4#"};
		{ 3, 33591, "", "=q4=Shadowcaster's Drape", "=ds=#s4#"};
		{ 4, 33489, "", "=q4=Mantle of Ill Intent", "=ds=#s3#, #a1#"};
		{ 5, 33480, "", "=q4=Cord of Braided Troll Hair", "=ds=#s10#, #a1#"};
		{ 6, 33483, "", "=q4=Life-step Belt", "=ds=#s10#, #a2#"};
		{ 7, 33971, "", "=q4=Elunite Imbued Leggings", "=ds=#s11#, #a2#"};
		...
		{ 19, 33492, "", "=q4=Trollbane", "=ds=#h2#, #w1#"};
		{ 20, 33490, "", "=q4=Staff of Dark Mending", "=ds=#w9#"};
		{ 21, 33494, "", "=q4=Amani Divining Staff", "=ds=#w9#"};
		{ 22, 33491, "", "=q4=Tuskbreaker", "=ds=#w5#"};
		{ 24, 0, "INV_Box_01", "=q6=#x32#", ""};
		{ 25, 33497, "", "=q4=Mana Attuned Band", "=ds=#s13#"};
		{ 26, 33500, "", "=q4=Signet of Eternal Life", "=ds=#s13#"};
		{ 27, 33496, "", "=q4=Signet of Primal Wrath", "=ds=#s13#"};
		{ 28, 33499, "", "=q4=Signet of the Last Defender", "=ds=#s13#"};
		{ 29, 33498, "", "=q4=Signet of the Quiet Forest", "=ds=#s13#"};
	};

	AtlasLoot_Data["ZATrash"] = {
		{ 1, 33993, "", "=q3=Mojo", "=ds=#e13#"};
		{ 3, 33865, "", "=q2=Amani Hex Stick", "=ds=#m20#"};
		{ 4, 33930, "", "=q2=Amani Charm of the Bloodletter", "=ds=#m26#"};
		{ 5, 33932, "", "=q2=Amani Charm of the Witch Doctor", "=ds=#m26#"};
		{ 6, 33931, "", "=q2=Amani Charm of Mighty Mojo", "=ds=#m26#"};
		{ 7, 33933, "", "=q2=Amani Charm of the Raging Defender", "=ds=#m26#"};
	};
	...
	AtlasLoot_Data["PvP70NonSet2"] = {
		...
		{ 16, 33883, "", "=q4=Vindicator's Dreadweave Cuffs", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 17, 33882, "", "=q4=Vindicator's Dreadweave Belt", "=ds=", "13923 #faction# 40 #ab#"};
		{ 18, 33884, "", "=q4=Vindicator's Dreadweave Stalkers", "=ds=", "13923 #faction# 40 #eos#"};
		{ 20, 33901, "", "=q4=Vindicator's Mooncloth Cuffs", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 21, 33900, "", "=q4=Vindicator's Mooncloth Belt", "=ds=", "13923 #faction# 40 #ab#"};
		{ 22, 33902, "", "=q4=Vindicator's Mooncloth Slippers", "=ds=", "13923 #faction# 40 #eos#"};
	...
	AtlasLoot_Data["PvP70NonSet3"] = {
		...
		{ 5, 35169, "", "=q4=Guardian's Kodohide Bracers", "=ds=", "11794 #faction# 20 #wsg#"};
		{ 6, 35154, "", "=q4=Guardian's Kodohide Belt", "=ds=", "17850 #faction# 40 #ab#"};
		{ 7, 35139, "", "=q4=Guardian's Kodohide Boots", "=ds=", "17850 #faction# 40 #eos#"};
		{ 9, 35171, "", "=q4=Guardian's Leather Bracers", "=ds=", "11794 #faction# 20 #wsg#"};
		{ 10, 35156, "", "=q4=Guardian's Leather Belt", "=ds=", "17850 #faction# 40 #ab#"};
		{ 11, 35141, "", "=q4=Guardian's Leather Boots", "=ds=", "17850 #faction# 40 #eos#"};
		{ 13, 35180, "", "=q4=Guardian's Wyrmhide Bracers", "=ds=", "11794 #faction# 20 #wsg#"};
		{ 14, 35165, "", "=q4=Guardian's Wyrmhide Belt", "=ds=", "17850 #faction# 40 #ab#"};
		{ 15, 35150, "", "=q4=Guardian's Wyrmhide Boots", "=ds=", "17850 #faction# 40 #eos#"};
		{ 16, 33881, "", "=q4=Vindicator's Dragonhide Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 17, 33879, "", "=q4=Vindicator's Dragonhide Belt", "=ds=", "13923 #faction# 40 #ab#"};
		{ 18, 33880, "", "=q4=Vindicator's Dragonhide Boots", "=ds=", "13923 #faction# 40 #eos#"};
		{ 20, 33887, "", "=q4=Vindicator's Kodohide Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 21, 33885, "", "=q4=Vindicator's Kodohide Belt", "=ds=", "13923 #faction# 40 #ab#"};
		{ 22, 33886, "", "=q4=Vindicator's Kodohide Boots", "=ds=", "13923 #faction# 40 #eos#"};
		{ 24, 33893, "", "=q4=Vindicator's Leather Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 25, 33891, "", "=q4=Vindicator's Leather Belt", "=ds=", "13923 #faction# 40 #ab#"};
		{ 26, 33892, "", "=q4=Vindicator's Leather Boots", "=ds=", "13923 #faction# 40 #eos#"};
	...
	AtlasLoot_Data["PvP70NonSet4"] = {
		...
		{ 16, 33876, "", "=q4=Vindicator's Chain Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 17, 33877, "", "=q4=Vindicator's Chain Girdle", "=ds=", "13923 #faction# 40 #ab#"};
		{ 18, 33878, "", "=q4=Vindicator's Chain Sabatons", "=ds=", "13923 #faction# 40 #eos#"};
		{ 20, 33894, "", "=q4=Vindicator's Linked Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 21, 33895, "", "=q4=Vindicator's Linked Girdle", "=ds=", "13923 #faction# 40 #ab#"};
		{ 22, 33896, "", "=q4=Vindicator's Linked Sabatons", "=ds=", "13923 #faction# 40 #eos#"};
		{ 24, 33897, "", "=q4=Vindicator's Mail Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 25, 33898, "", "=q4=Vindicator's Mail Girdle", "=ds=", "13923 #faction# 40 #ab#"};
		{ 26, 33899, "", "=q4=Vindicator's Mail Sabatons", "=ds=", "13923 #faction# 40 #eos#"};
	...
	AtlasLoot_Data["PvP70NonSet5"] = {
		...
		{ 5, 35175, "", "=q4=Guardian's Ornamented Bracers", "=ds=", "11794 #faction# 20 #wsg#"};
		{ 6, 35160, "", "=q4=Guardian's Ornamented Belt", "=ds=", "17850 #faction# 40 #ab#"};
		{ 7, 35145, "", "=q4=Guardian's Ornamented Greaves", "=ds=", "17850 #faction# 40 #eos#"};
		{ 9, 35176, "", "=q4=Guardian's Plate Bracers", "=ds=", "11794 #faction# 20 #wsg#"};
		{ 10, 35161, "", "=q4=Guardian's Plate Belt", "=ds=", "17850 #faction# 40 #ab#"};
		{ 11, 35146, "", "=q4=Guardian's Plate Greaves", "=ds=", "17850 #faction# 40 #eos#"};
		{ 13, 35178, "", "=q4=Guardian's Scaled Bracers", "=ds=", "11794 #faction# 20 #wsg#"};
		{ 14, 35163, "", "=q4=Guardian's Scaled Belt", "=ds=", "17850 #faction# 40 #ab#"};
		{ 15, 35148, "", "=q4=Guardian's Scaled Greaves", "=ds=", "17850 #faction# 40 #eos#"};
		{ 16, 33889, "", "=q4=Vindicator's Lamellar Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 17, 33888, "", "=q4=Vindicator's Lamellar Belt", "=ds=", "13923 #faction# 40 #ab#"};
		{ 18, 33890, "", "=q4=Vindicator's Lamellar Greaves", "=ds=", "13923 #faction# 40 #eos#"};
		{ 20, 33904, "", "=q4=Vindicator's Ornamented Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 21, 33903, "", "=q4=Vindicator's Ornamented Belt", "=ds=", "13923 #faction# 40 #ab#"};
		{ 22, 33905, "", "=q4=Vindicator's Ornamented Greaves", "=ds=", "13923 #faction# 40 #eos#"};
		{ 24, 33813, "", "=q4=Vindicator's Plate Bracers", "=ds=", "9199 #faction# 20 #wsg#"};
		{ 25, 33811, "", "=q4=Vindicator's Plate Belt", "=ds=", "13923 #faction# 40 #ab#"};
		{ 26, 33812, "", "=q4=Vindicator's Plate Greaves", "=ds=", "13923 #faction# 40 #eos#"};
	...
	AtlasLoot_Data["DS3Cloth"] = {
		...
		{ 20, 27508, "", "=q3=Incanter's Gloves", "=ds=Thespia ("..BabbleZone["The Steamvault"]..")"};
	...
	AtlasLoot_Data["Mounts22"] = {
		...
		{ 20, 25532, "", "=q4=Swift Yellow Wind Rider", "=ds=#e12#"};
		{ 21, 25475, "", "=q3=Blue Wind Rider", "=ds=#e12#"};
		{ 22, 25476, "", "=q3=Green Wind Rider", "=ds=#e12#"};
		{ 23, 25474, "", "=q3=Tawny Wind Rider", "=ds=#e12#"};
		Next = "Mounts23";
		Prev = "Mounts21";
		Back = "MOUNTMENU";
	};
	...
	AtlasLoot_Data["Mounts23"] = {
		...
		{ 5, 29231, "", "=q4=Reins of the White War Talbuk", "=ds=#e12#"};
		{ 6, 31830, "", "=q4=Reins of the Cobalt Riding Talbuk", "=ds=#e12#"};
	...
	AtlasLoot_Data["Mounts24"] = {
		...
		{ 27, 29228, "", "=q4=Reins of the Dark War Talbuk", "=ds=#e12#"};
		Next = "Mounts25";
		Prev = "Mounts23";
		Back = "MOUNTMENU";
	};
	...
	AtlasLoot_Data["Mounts25"] = {
		...
		{ 6, 35513, "", "=q4=Swift White Hawkstrider", "=q2=#n59#, =q1=#z30#"};
		{ 7, 37719, "", "=q4=Swift Zhevra", "=ds=#e12#"};
		{ 8, 43599, "", "=q3=Big Blizzard Bear", "=ds=#e12#"};
		{ 10, 0, "INV_Box_01", "=q6=#j31#", ""};
		{ 11, 38576, "", "=q4=Big Battle Bear", "=q2=#m24#"};
		{ 12, 33225, "", "=q4=Reins of the Swift Spectral Tiger", "=q2=#m24#"};
		{ 13, 35226, "", "=q4=X-51 Nether-Rocket X-TREME", "=q2=#m24#"};
		{ 14, 33224, "", "=q3=Reins of the Spectral Tiger", "=q2=#m24#"};
		{ 15, 35225, "", "=q3=X-51 Nether-Rocket", "=q2=#m24#"};
		{ 16, 0, "INV_Box_01", "=q6=#j33#", ""};
		{ 17, 37828, "", "=q4=Great Brewfest Kodo", "=q2=#n150#"};
		{ 18, 33977, "", "=q4=Swift Brewfest Ram", "=q2=#n150#"};
