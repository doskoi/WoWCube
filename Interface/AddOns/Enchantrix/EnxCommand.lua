--[[
	...
	Revision: $Id: EnxCommand.lua 3846 2008-11-20 22:31:51Z ccox $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Enchantrix/EnxCommand.lua $", "$Rev: 3846 $")
