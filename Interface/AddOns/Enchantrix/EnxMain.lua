--[[
	...
	Revision: $Id: EnxMain.lua 3599 2008-10-14 04:48:20Z ccox $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Enchantrix/EnxMain.lua $", "$Rev: 3599 $")
...
function addonLoaded(hookArgs, event, addOnName)
	...
	Enchantrix.Revision = Enchantrix.Util.GetRevision("$Revision: 3599 $")
