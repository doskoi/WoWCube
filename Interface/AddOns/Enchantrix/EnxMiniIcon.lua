--[[
	...
	Revision: $Id: EnxMiniIcon.lua 3576 2008-10-10 03:07:13Z aesir $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.2/Enchantrix/EnxMiniIcon.lua $", "$Rev: 3576 $")
