...
local MINOR_VERSION = 90000 + tonumber(("$Revision: 162 $"):match("%d+"))
...
--The Culling of Stratholme
	...
	["Infinite Corruptor"] = true, -- Stratholme Past (Heroic)
--The Black Morass
	["Aeonus"] = true,
...
--The Oculus
		["Drakos the Interrogator"] = "Drakos der Fragensteller",
...
--The Culling of Stratholme
		...
		["Mal'Ganis"] = "Mal'Ganis",
		["Salramm the Fleshcrafter"] = "Salramm der Fleischhandwerker",
		["Infinite Corruptor"] = "Ewiger Verderber",  -- Stratholme Past (Heroic)
--The Black Morass
		["Aeonus"] = "Aeonus",
...
--Howling Fjord
--Utgarde Keep
		["Constructor & Controller"] = "Konstrukteur & Kontrolleur", --these are one encounter, so we do this as an encounter name
...
-- Zul'Drak
-- Gundrak
		["Eck the Ferocious"] = "Eck der Grausame",
		["Drakkari Colossus"] = "Drakkari Koloss",
		["Gal'darah"] = "Gal'darah",
		["Moorabi"] = "Moorabi",
		["Slad'ran"] = "Slad'ran",
...
--The Culling of Stratholme
		...
		["Infinite Corruptor"] = "Corrupteur infini",  -- Stratholme Past (Heroic)
--The Black Morass
		["Aeonus"] = "Aeonus",
...
--The Culling of Stratholme (净化斯坦索姆)
		...
		["Infinite Corruptor"] = "永恒腐蚀者", -- Stratholme Past (Heroic)
--The Black Morass
		["Aeonus"] = "埃欧努斯",
...
--Howling Fjord (嚎风峡湾)
--Utgarde Keep (乌特加德城堡)
		["Constructor & Controller"] = "建筑师与控制者", --these are one encounter, so we do this as an encounter name
...
--The Culling of Stratholme
		...
		["Infinite Corruptor"] = "恆龍墮落者", -- Stratholme Past (Heroic)
--The Black Morass
		["Aeonus"] = "艾奧那斯",
...
--Howling Fjord
--Utgarde Keep
		["Constructor & Controller"] = "『建造者』與『控制者』", --these are one encounter, so we do this as an encounter name
...
--Blackrock Depths
		...
		["Seeth'rel"] = "불안의 문지기",
		["The Seven Dwarves"] = "The Seven Dwarves", -- CHECK
		["Verek"] = "베레크",
		["Vile'rel"] = "타락의 문지기",
...
--The Culling of Stratholme
		...
		["Infinite Corruptor"] = "무한의 타락자", -- Stratholme Past (Heroic)
--The Black Morass
		["Aeonus"] = "아에누스",
...
--Blackrock Depths
		...
		["Seeth'rel"] = "Seeth'rel",
		["The Seven Dwarves"] = "Los Siete Enanitos",  -- check
		["Verek"] = "Verek",
		["Vile'rel"] = "Vil'rel",
...
--Hellfire Ramparts
		...
		["Vazruden"] = "Vazruden",
		["Watchkeeper Gargolmar"] = "Guardi\195\161n vigía Gargolmar",
--Magtheridon's Lair
...
--Utgarde Keep
		--["Constructor & Controller"] = true, --these are one encounter, so we do this as an encounter name
		["Dalronn the Controller"] = "Dalronn el Controlador", --Check
		["Ingvar the Plunderer"] = "Ingvar the Plunderer", --Fix
...
--		["Cache of the Firelord"] = true, --Fix
		["Garr"] = "Garr",
		["Gehennas"] = "Gehennas",
...
--Sunwell Plateau
		["Kalecgos"] = "Kalecgos",
		["Sathrovarr the Corruptor"] = "Sathrovarr el Corruptor", --Check
		["Brutallus"] = "Brutallus",
		["Felmyst"] = "Brumavil",
		["Kil'jaeden"] = "Kil'jaeden",
		["M'uru"] = "M'uru",
		["The Eredar Twins"] = "Los Gemelos Eredar", --Check
		["Lady Sacrolash"] = "Lady Sacrolash", --Check
...
--World Bosses
		...
		["Emeriss"] = "Emeriss",
		["High Marshal Whirlaxis"] = "High Marshal Whirlaxis", --Fix
		["Lethon"] = "Lethon",
                ["Lord Kazzak"] = "Lord Kazzak",
		["Lord Skwol"] = "Lord Skwol",
...
--Blackrock Depths
		...
		["Magmus"] = "Magmus",
		["Ok'thor the Breaker"] = "Ok'thor el Rompedor",
		["Overmaster Pyron"] = "Gran maestro Pyron", -- reported by Quakero
		["Panzor the Invincible"] = "Panzor el Invencible",
		["Phalanx"] = "Falange",
		["Plugger Spazzring"] = "Plugger Aropatoso",
		["Princess Moira Bronzebeard"] = "Princesa Moira Barbabronce",
...
--The Oculus
		...
		["Varos Cloudstrider"] = "Varos Cloudstrider", --Check
...
--Old Hillsbrad Foothills
		...
		["Lieutenant Drake"] = "Teniente Draco",
--The Culling of Stratholme
		["Meathook"] = "Meathook", --Check
		["Chrono-Lord Epoch"] = "Chrono-Lord Epoch", --Check
		["Mal'Ganis"] = "Mal'Ganis", --Check
		["Salramm the Fleshcrafter"] = "Salramm the Fleshcrafter", --Check
...
--Chamber of Aspects
--The Obsidian Sanctum
		["Sartharion"] = "Sartharion", --Check
		["Shadron"] = "Shadron", --Check
		["Tenebron"] = "Tenebron", --Check
		["Vesperon"] = "Vesperon", --Check
...
--Howling Fjord
--Utgarde Keep
		["Constructor & Controller"] = "Constructor y Controlador", --these are one encounter, so we do this as an encounter name
		["Dalronn the Controller"] = "Dalronn el Controlador", --Check
		["Ingvar the Plunderer"] = "Ingvar the Plunderer", --Fix
		["Prince Keleseth"] = "Príncipe Keleseth",
		["Skarvald the Constructor"] = "Skarvald el Constructor", --Check
...
-- Zul'Drak
-- Gundrak
		["Eck the Ferocious"] = "Eck the Ferocious", --Check
...
--The Culling of Stratholme
		...
		["Infinite Corruptor"] = "Осквернитель из рода Бесконечности", -- Stratholme Past (Heroic)
--The Black Morass
		["Aeonus"] = "Эонус",
...
--Howling Fjord
--Utgarde Keep
		["Constructor & Controller"] = "Строитель и Контролирующий", --these are one encounter, so we do this as an encounter name
