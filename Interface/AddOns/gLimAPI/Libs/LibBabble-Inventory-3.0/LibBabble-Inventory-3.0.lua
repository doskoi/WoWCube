...
local MINOR_VERSION = 90000 + tonumber(("$Revision: 68 $"):match("(%d+)"))
...
elseif GAME_LOCALE == "frFR" then
	lib:SetCurrentTranslations {
		...
		["Inscription Bag"] = "Sac de calligraphie", -- New 3.0
		...
		-- Jewelcrafting already defined
		["Materials"] = "Matériaux",
		["Armor Enchantment"] = "Enchantements d'armure", --New 3.0
		["Weapon Enchantment"] = "Enchantements d'arme", --New 3.0
		-- Other already defined
...
elseif GAME_LOCALE == "esES" then
	lib:SetCurrentTranslations {
		...
		["Inscription Bag"] = "Bolsa de Inscripción", -- New 3.0
		...
		["Armor Enchantment"] = "Mejora en armaduras", --New 3.0
		["Weapon Enchantment"] = "Mejora en armas", --New 3.0
		-- Other already defined
