...
local MINOR_VERSION = 90000 + tonumber(("$Revision: 171 $"):match("%d+"))
...
elseif GAME_LOCALE == "deDE" then
	lib:SetCurrentTranslations {
		...
		["Zul'Drak"] = "Zul'Drak",
		["The Frozen Sea"] = "Der gefrorene See",
...
elseif GAME_LOCALE == "koKR" then
	lib:SetCurrentTranslations {
		...
		["Icecrown Citadel"] = "얼음왕관 요새", -- CHECK
		["The Nexus"] = "마력의 탑",
