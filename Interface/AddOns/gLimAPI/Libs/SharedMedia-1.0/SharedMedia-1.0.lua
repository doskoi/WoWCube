...
local vmajor, vminor = "SharedMedia-1.0", "$Revision: 99999 $"
...
function lib:Fetch(m, n, noDefault)
	...
	if locale == "zhTW" then
		if m == "font" and result and result ~= "Fonts\\bHEI00M.ttf" and result ~= "Fonts\\bHEI01B.ttf" and result ~= "Fonts\\bKAI00M.ttf" and result ~= "Fonts\\FZBWJW.TTF" and result ~= "Fonts\\FZJZJW.TTF" and result ~= "Fonts\\FZLBJW.TTF" and result ~= "Fonts\\FZXHJW.TTF" and result ~= "Fonts\\FZXHLJW.TTF" then
			result = "Fonts\\FZLBJW.TTF"
		end
	elseif locale == "zhCN" then
		if m == "font" and result and result ~= "Fonts\\ZYKai_T.TTF" and result ~= "Fonts\\ZYKai_C.TTF" and result ~= "Fonts\\ZYHei.TTF" and result ~= "Fonts\\FZBWJW.TTF" and result ~= "Fonts\\FZJZJW.TTF" and result ~= "Fonts\\FZLBJW.TTF" and result ~= "Fonts\\FZXHJW.TTF" and result ~= "Fonts\\FZXHLJW.TTF" then
...
local function activate(self, oldLib, oldDeactivate)
	...
	elseif locale == "zhTW" then
		...
		mediaTable["font"]["任務"] = "Fonts\\bHEI01B.TTF"
		mediaTable["font"]["傷害數字"] = "Fonts\\bLEI00D.TTF"
		mediaTable["font"]["預設"] = "Fonts\\bHEI00M.TTF"
		mediaTable["font"]["提示訊息"] = "Fonts\\bKAI00M.TTF"
		mediaTable["font"]["聊天"] = "Fonts\\bHEI00M.TTF"
	elseif locale == "zhCN" then
