...
---- Azuregos/Highlord Kruul
	...
	AtlasLoot_Data["AQ20Ossirian"] = {
		...
		{ 25, 20886, "", "=q4=Qiraji Spiked Hilt", "#m3#", "", "35.27%"};
		{ 26, 20890, "", "=q4=Qiraji Ornate Hilt", "#m3#", "", "30.69%"};
		{ 27, 20884, "", "=q3=Qiraji Magisterial Ring", "#m3#", "", "9.65%"};
		{ 28, 20888, "", "=q3=Qiraji Ceremonial Ring", "#m3#", "", "8.53%"};
	};
	...
	AtlasLoot_Data["AQ40Vem"] = {
		{ 1, 21697, "", "=q4=Cape of the Trinity", "=ds=#s4# =q2=#m5#"};
		{ 2, 21694, "", "=q4=Ternary Mantle", "=ds=#s3#, #a1# =q2=#m5#"};
		{ 3, 21696, "", "=q4=Robes of the Triumvirate", "=ds=#s5#, #a1# =q2=#m5#"};
		{ 4, 21693, "", "=q4=Guise of the Devourer", "=ds=#s1#, #a2# =q2=#m5#"};
		{ 5, 21692, "", "=q4=Triad Girdle", "=ds=#s10#, #a4# =q2=#m5#"};
		{ 6, 21695, "", "=q4=Angelista's Touch", "=ds=#s13# =q2=#m5#"};
		{ 8, 21237, "", "=q4=Imperial Qiraji Regalia", "=ds=#m3# =q2=#m5#"};
		{ 9, 21232, "", "=q4=Imperial Qiraji Armaments", "=ds=#m3# =q2=#m5#"};
		{ 11, 21680, "", "=q4=Vest of Swift Execution", "=ds=#s5#, #a2# =q2=#n115#"};
		{ 12, 21603, "", "=q4=Wand of Qiraji Nobility", "=ds=#w12# =q2=#n115#"};
		{ 13, 21681, "", "=q4=Ring of the Devoured", "=ds=#s13# =q2=#n115#"};
		{ 14, 21685, "", "=q4=Petrified Scarab", "=ds=#s14# =q2=#n115#"};
		{ 16, 21689, "", "=q4=Gloves of Ebru", "=ds=#s9#, #a2# =q2=#n116#"};
		{ 17, 21691, "", "=q4=Ooze-ridden Gauntlets", "=ds=#s9#, #a4# =q2=#n116#"};
		{ 18, 21688, "", "=q4=Boots of the Fallen Hero", "=ds=#s12#, #a4# =q2=#n116#"};
		{ 19, 21690, "", "=q4=Angelista's Charm", "=ds=#s2# =q2=#n116#"};
		{ 21, 21686, "", "=q4=Mantle of Phrenic Power", "=ds=#s3#, #a1# =q2=#n117#"};
		{ 22, 21682, "", "=q4=Bile-Covered Gauntlets", "=ds=#s9#, #a2# =q2=#n117#"};
		{ 23, 21684, "", "=q4=Mantle of the Desert's Fury", "=ds=#s3#, #a3# =q2=#n117#"};
		{ 24, 21683, "", "=q4=Mantle of the Desert Crusade", "=ds=#s3#, #a4# =q2=#n117#"};
		{ 25, 21687, "", "=q4=Ukko's Ring of Darkness", "=ds=#s13# =q2=#n117#"};
	};
	...
	AtlasLoot_Data["BRDImperatorDagranThaurissan"] = {
		...
		{ 10, 11931, "", "=q3=Dreadforge Retaliator", "=ds=#h2#, #w1#", "", "15.76%"};
		{ 11, 11932, "", "=q3=Guiding Stave of Wisdom", "=ds=#w9#", "", "15.01%"};
		{ 12, 11928, "", "=q3=Thaurissan's Royal Scepter", "=ds=#s15#", "", " 12.86%"};
		{ 14, 12033, "", "=q1=Thaurissan Family Jewels", "=ds=#e7# #e1#", "", "2.2%"};
		{ 16, 21524, "", "=q2=Red Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
	};
	...
	AtlasLoot_Data["UBRSAnvilcrack"] = {
		...
		{ 14, 21525, "", "=q2=Green Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
	...
	AtlasLoot_Data["MCLucifron"] = {
		{ 1, 16800, "", "=q4=Arcanist Boots", "=q1=#m1# =ds=#c3# (T1)", "", "12.06%"};
		{ 2, 16805, "", "=q4=Felheart Gloves", "=q1=#m1# =ds=#c8# (T1)", "", "14.89%"};
		{ 3, 16829, "", "=q4=Cenarion Boots", "=q1=#m1# =ds=#c1# (T1)", "", "10.72%"};
		{ 4, 16837, "", "=q4=Earthfury Boots", "=q1=#m1# =ds=#c7# (T1)", "", "4.16%"};
		{ 5, 16863, "", "=q4=Gauntlets of Might", "=q1=#m1# =ds=#c9# (T1)", "", "16.40%"};
		{ 6, 16859, "", "=q4=Lawbringer Boots", "=q1=#m1# =ds=#c4# (T1)", "", "7.20%"};
		{ 15, 17329, "", "=q1=Hand of Lucifron", "=ds=#m3#"};
		{ 16, 18872, "", "=q4=Manastorm Leggings", "=ds=#s11#, #a1#", "", "1.93%"};
		{ 17, 19145, "", "=q4=Robe of Volatile Power", "=ds=#s5#, #a1#", "", "1.84%"};
		{ 18, 19146, "", "=q4=Wristguards of Stability", "=ds=#s8#, #a2#", "", "1.95%"};
		{ 19, 18875, "", "=q4=Salamander Scale Pants", "=ds=#s11#, #a2#", "", "2.00%"};
		{ 20, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "1.09%"};
		{ 21, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.15%"};
		{ 22, 17109, "", "=q4=Choker of Enlightenment", "=ds=#s2#", "", "12.61%"};
		{ 23, 18879, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "2.04%"};
		{ 24, 19147, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "2.23%"};
		{ 25, 18878, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "2.23%"};
		{ 26, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "1.60%"};
		{ 30, 16665, "", "=q2=Tome of Tranquilizing Shot", "=ds=#e10#, =q1=#m1# =ds=#c2#", "", "100%"};
	};

	AtlasLoot_Data["MCMagmadar"] = {
		{ 1, 16796, "", "=q4=Arcanist Leggings", "=q1=#m1# =ds=#c3# (T1)", "", "14.57%"};
		{ 2, 16814, "", "=q4=Pants of Prophecy", "=q1=#m1# =ds=#c5# (T1)", "", "14.33%"};
		{ 3, 16810, "", "=q4=Felheart Pants", "=q1=#m1# =ds=#c8# (T1)", "", "13.75%"};
		{ 4, 16822, "", "=q4=Nightslayer Pants", "=q1=#m1# =ds=#c6# (T1)", "", "13.83%"};
		{ 5, 16847, "", "=q4=Giantstalker's Leggings", "=q1=#m1# =ds=#c2# (T1)", "", "13.28%"};
		{ 6, 16835, "", "=q4=Cenarion Leggings", "=q1=#m1# =ds=#c1# (T1)", "", "12.90%"};
		{ 7, 16843, "", "=q4=Earthfury Legguards", "=q1=#m1# =ds=#c7# (T1)", "", " 4.73%"};
		{ 8, 16855, "", "=q4=Lawbringer Legplates", "=q1=#m1# =ds=#c4# (T1)", "", "8.54%"};
		{ 9, 16867, "", "=q4=Legplates of Might", "=q1=#m1# =ds=#c9# (T1)", "", "13.97%"};
		{ 16, 19136, "", "=q4=Mana Igniting Cord", "=ds=#s10#, #a1#", "", "4.79%"};
		{ 17, 18823, "", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "", "6.18%"};
		{ 18, 18829, "", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "", "2.10%"};
		{ 19, 19144, "", "=q4=Sabatons of the Flamewalker", "=ds=#s12#, #a3#", "", "1.86%"};
		{ 20, 19143, "", "=q4=Flameguard Gauntlets", "=ds=#s9#, #a4#", "", "5.48%"};
		{ 21, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "3.98%"};
		{ 22, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "3.22%"};
		{ 23, 17065, "", "=q4=Medallion of Steadfast Might", "=ds=#s2#", "", "14.05%"};
		{ 24, 18821, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "5.79%"};
		{ 25, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "5.55%"};
		{ 26, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "5.42%"};
		{ 27, 18203, "", "=q4=Eskhandar's Right Claw", "=ds=#h3#, #w13#", "", "17.82%"};
		{ 28, 18822, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "5.68%"};
		{ 29, 17073, "", "=q4=Earthshaker", "=ds=#h2#, #w6#", "", "16.75%"};
		{ 30, 17069, "", "=q4=Striker's Mark", "=ds=#w2#", "", "16.37%"};
	};

	AtlasLoot_Data["MCGehennas"] = {
		{ 1, 16812, "", "=q4=Gloves of Prophecy", "=q1=#m1# =ds=#c5# (T1)", "", "18.65%"};
		{ 2, 16826, "", "=q4=Nightslayer Gloves", "=q1=#m1# =ds=#c6# (T1)", "", "19.47%"};
		{ 3, 16849, "", "=q4=Giantstalker's Boots", "=q1=#m1# =ds=#c2# (T1)", "", "14.54%"};
		{ 4, 16839, "", "=q4=Earthfury Gauntlets", "=q1=#m1# =ds=#c7# (T1)", "", "7.38%"};
		{ 5, 16862, "", "=q4=Sabatons of Might", "=q1=#m1# =ds=#c9# (T1)", "", "14.48%"};
		{ 6, 16860, "", "=q4=Lawbringer Gauntlets", "=q1=#m1# =ds=#c4# (T1)", "", "11.77%"};
		{ 15, 17331, "", "=q1=Hand of Gehennas", "=ds=#m3#"};
		{ 16, 19145, "", "=q4=Robe of Volatile Power", "=ds=#s5#, #a1#", "", "3.83%"};
		{ 17, 18872, "", "=q4=Manastorm Leggings", "=ds=#s11#, #a1#", "", "3.37%"};
		{ 18, 19146, "", "=q4=Wristguards of Stability", "=ds=#s8#, #a2#", "", "3.53%"};
		{ 19, 18875, "", "=q4=Salamander Scale Pants", "=ds=#s11#, #a2#", "", "3.57%"};
		{ 20, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "1.77%"};
		{ 21, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "3.48%"};
		{ 22, 18879, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "3.78%"};
		{ 23, 19147, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "3.78%"};
		{ 24, 18878, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "3.79%"};
		{ 25, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "3.34%"};
	};

	AtlasLoot_Data["MCGarr"] = {
		{ 1, 16795, "", "=q4=Arcanist Crown", "=q1=#m1# =ds=#c3# (T1)", "", "11.31%"};
		{ 2, 16813, "", "=q4=Circlet of Prophecy", "=q1=#m1# =ds=#c5# (T1)", "", "11.36%"};
		{ 3, 16808, "", "=q4=Felheart Horns", "=q1=#m1# =ds=#c8# (T1)", "", "10.62%"};
		{ 4, 16846, "", "=q4=Giantstalker's Helmet", "=q1=#m1# =ds=#c2# (T1)", "", "11.57%"};
		{ 5, 16834, "", "=q4=Cenarion Helm", "=q1=#m1# =ds=#c1# (T1)", "", "11.51%"};
		{ 6, 16821, "", "=q4=Nightslayer Cover", "=q1=#m1# =ds=#c6# (T1)", "", "10.38%"};
		{ 7, 16842, "", "=q4=Earthfury Helmet", "=q1=#m1# =ds=#c7# (T1)", "", "3.91%"};
		{ 8, 16866, "", "=q4=Helm of Might", "=q1=#m1# =ds=#c9# (T1)", "", "11.39%"};
		{ 9, 16854, "", "=q4=Lawbringer Helm", "=q1=#m1# =ds=#c4# (T1)", "", "7.23%"};
		{ 14, 18564, "", "=q5=Bindings of the Windseeker", "=ds=#m3#, =q1=#m9#", "", "3.74%"};
		{ 15, 19019, "", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4#: =ds=#h1#, #w10#"};
		{ 16, 19136, "", "=q4=Mana Igniting Cord", "=ds=#s10#, #a1#", "", "4.80%"};
		{ 17, 18823, "", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "", "5.23%"};
		{ 18, 18829, "", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "", "1.68%"};
		{ 19, 19144, "", "=q4=Sabatons of the Flamewalker", "=ds=#s12#, #a3#", "", "1.48%"};
		{ 20, 19143, "", "=q4=Flameguard Gauntlets", "=ds=#s9#, #a4#", "", "3.84%"};
		{ 21, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.82%"};
		{ 22, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "3.05%"};
		{ 23, 18821, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "4.48%"};
		{ 24, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "4.13%"};
		{ 25, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "3.69%"};
		{ 26, 17071, "", "=q4=Gutgore Ripper", "=ds=#h1#, #w4#", "", "11.21%"};
		{ 27, 18832, "", "=q4=Brutality Blade", "=ds=#h1#, #w10#", "", "13.27%"};
		{ 28, 18822, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "4.09%"};
		{ 29, 17105, "", "=q4=Aurastone Hammer", "=ds=#h3#, #w6#", "", "12.67%"};
		{ 30, 17066, "", "=q4=Drillborer Disk", "=ds=#w8#", "", "11.85%"};
	};

	AtlasLoot_Data["MCShazzrah"] = {
		{ 1, 16801, "", "=q4=Arcanist Gloves", "=q1=#m1# =ds=#c3# (T1)", "", "19.59%"};
		{ 2, 16803, "", "=q4=Felheart Slippers", "=q1=#m1# =ds=#c8# (T1)", "", "15.28%"};
		{ 3, 16811, "", "=q4=Boots of Prophecy", "=q1=#m1# =ds=#c5# (T1)", "", "14.90%"};
		{ 4, 16831, "", "=q4=Cenarion Gloves", "=q1=#m1# =ds=#c1# (T1)", "", "19.53%"};
		{ 5, 16852, "", "=q4=Giantstalker's Gloves", "=q1=#m1# =ds=#c2# (T1)", "", "18.58%"};
		{ 6, 16824, "", "=q4=Nightslayer Boots", "=q1=#m1# =ds=#c6# (T1)", "", "15.58%"};
		{ 15, 17332, "", "=q1=Hand of Shazzrah", "=ds=#m3#"};
		{ 16, 19145, "", "=q4=Robe of Volatile Power", "=ds=#s5#, #a1#", "", "1.97%"};
		{ 17, 18872, "", "=q4=Manastorm Leggings", "=ds=#s11#, #a1#", "", "1.84%"};
		{ 18, 19146, "", "=q4=Wristguards of Stability", "=ds=#s8#, #a2#", "", "1.85%"};
		{ 19, 18875, "", "=q4=Salamander Scale Pants", "=ds=#s11#, #a2#", "", "1.81%"};
		{ 20, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "0.78%"};
		{ 21, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.22%"};
		{ 22, 18879, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "1.72%"};
		{ 23, 19147, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "1.99%"};
		{ 24, 18878, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "2.27%"};
		{ 25, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "3.32%"};
	};

	AtlasLoot_Data["MCGeddon"] = {
		{ 1, 16797, "", "=q4=Arcanist Mantle", "=q1=#m1# =ds=#c3# (T1)", "", "19.92%"};
		{ 2, 16807, "", "=q4=Felheart Shoulder Pads", "=q1=#m1# =ds=#c8# (T1)", "", "19.78%"};
		{ 3, 16836, "", "=q4=Cenarion Spaulders", "=q1=#m1# =ds=#c1# (T1)", "", "19.52%"};
		{ 4, 16856, "", "=q4=Lawbringer Spaulders", "=q1=#m1# =ds=#c4# (T1)", "", "12.62%"};
		{ 5, 16844, "", "=q4=Earthfury Epaulets", "=q1=#m1# =ds=#c7# (T1)", "", "7.29%"};
		{ 14, 18563, "", "=q5=Bindings of the Windseeker", " =ds=#m3#, =q1=#m10#", "", "3.78%"};
		{ 15, 19019, "", "=q5=Thunderfury, Blessed Blade of the Windseeker", "=q1=#m4#: =ds=#h1#, #w10#"};
		{ 16, 19136, "", "=q4=Mana Igniting Cord", "=ds=#s10#, #a1#", "", "2.44%"};
		{ 17, 18823, "", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "", "3.04%"};
		{ 18, 18829, "", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "", "1.04%"};
		{ 19, 19144, "", "=q4=Sabatons of the Flamewalker", "=ds=#s12#, #a3#", "", "1.00%"};
		{ 20, 19143, "", "=q4=Flameguard Gauntlets", "=ds=#s9#, #a4#", "", "2.61%"};
		{ 21, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "1.77%"};
		{ 22, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "1.48%"};
		{ 23, 17110, "", "=q4=Seal of the Archmagus", "=ds=#s13#", "", "21.93%"};
		{ 24, 18821, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "2.61%"};
		{ 25, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "2.68%"};
		{ 26, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "2.59%"};
		{ 27, 18822, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "2.70%"};
	};

	AtlasLoot_Data["MCGolemagg"] = {
		{ 1, 16798, "", "=q4=Arcanist Robes", "=q1=#m1# =ds=#c3# (T1)", "", "16.51%"};
		{ 2, 16815, "", "=q4=Robes of Prophecy", "=q1=#m1# =ds=#c5# (T1)", "", "15.65%"};
		{ 3, 16809, "", "=q4=Felheart Robes", "=q1=#m1# =ds=#c8# (T1)", "", "15.66%"};
		{ 4, 16820, "", "=q4=Nightslayer Chestpiece", "=q1=#m1# =ds=#c6# (T1)", "", "16.76%"};
		{ 5, 16833, "", "=q4=Cenarion Vestments", "=q1=#m1# =ds=#c1# (T1)", "", "15.21%"};
		{ 6, 16845, "", "=q4=Giantstalker's Breastplate", "=q1=#m1# =ds=#c2# (T1)", "", "15.83%"};
		{ 7, 16841, "", "=q4=Earthfury Vestments", "=q1=#m1# =ds=#c7# (T1)", "", " 6.08%"};
		{ 8, 16865, "", "=q4=Breastplate of Might", "=q1=#m1# =ds=#c9# (T1)", "", "15.28%"};
		{ 9, 16853, "", "=q4=Lawbringer Chestguard", "=q1=#m1# =ds=#c4# (T1)", "", "9.53%"};
		{ 14, 17203, "", "=q4=Sulfuron Ingot", "=ds=#m3#", "", "11.98%"};
		{ 15, 17182, "", "=q5=Sulfuras, Hand of Ragnaros", "=q1=#m4#: =ds=#h2#, #w6#"};
		{ 16, 19136, "", "=q4=Mana Igniting Cord", "=ds=#s10#, #a1#", "", "2.18%"};
		{ 17, 18823, "", "=q4=Aged Core Leather Gloves", "=ds=#s9#, #a2#", "", "2.65%"};
		{ 18, 18829, "", "=q4=Deep Earth Spaulders", "=ds=#s3#, #a3#", "", "1.20%"};
		{ 19, 19144, "", "=q4=Sabatons of the Flamewalker", "=ds=#s12#, #a3#", "", "1.00%"};
		{ 20, 19143, "", "=q4=Flameguard Gauntlets", "=ds=#s9#, #a4#", "", "2.17%"};
		{ 21, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "1.44%"};
		{ 22, 18824, "", "=q4=Magma Tempered Boots", "=ds=#s12#, #a4#", "", "1.69%"};
		{ 23, 18821, "", "=q4=Quick Strike Ring", "=ds=#s13#", "", "2.26%"};
		{ 24, 18820, "", "=q4=Talisman of Ephemeral Power", "=ds=#s14#", "", "2.91%"};
		{ 25, 19142, "", "=q4=Fire Runed Grimoire", "=ds=#s15#", "", "2.46%"};
		{ 26, 17103, "", "=q4=Azuresong Mageblade", "=ds=#h3#, #w10#", "", "17.59%"};
		{ 27, 18822, "", "=q4=Obsidian Edged Blade", "=ds=#h2#, #w10#", "", "2.89%"};
		{ 28, 18842, "", "=q4=Staff of Dominance", "=ds=#w9#", "", "18.95%"};
		{ 29, 17072, "", "=q4=Blastershot Launcher", "=ds=#w5#", "", "17.83%"};
	};

	AtlasLoot_Data["MCSulfuron"] = {
		{ 1, 16816, "", "=q4=Mantle of Prophecy", "=q1=#m1# =ds=#c5# (T1)", "", "21.06%"};
		{ 2, 16823, "", "=q4=Nightslayer Shoulder Pads", "=q1=#m1# =ds=#c6# (T1)", "", "20.66%"};
		{ 3, 16848, "", "=q4=Giantstalker's Epaulets", "=q1=#m1# =ds=#c2# (T1)", "", "19.64%"};
		{ 4, 16868, "", "=q4=Pauldrons of Might", "=q1=#m1# =ds=#c9# (T1)", "", "21.14%"};
		{ 15, 17330, "", "=q1=Hand of Sulfuron", "=ds=#m3#"};
		{ 16, 19145, "", "=q4=Robe of Volatile Power", "=ds=#s5#, #a1#", "", "2.80%"};
		{ 17, 18872, "", "=q4=Manastorm Leggings", "=ds=#s11#, #a1#", "", "2.54%"};
		{ 18, 19146, "", "=q4=Wristguards of Stability", "=ds=#s8#, #a2#", "", "2.70%"};
		{ 19, 18875, "", "=q4=Salamander Scale Pants", "=ds=#s11#, #a2#", "", "2.58%"};
		{ 20, 18870, "", "=q4=Helm of the Lifegiver", "=ds=#s1#, #a3#", "", "1.26%"};
		{ 21, 18861, "", "=q4=Flamewaker Legplates", "=ds=#s11#, #a4#", "", "2.54%"};
		{ 22, 18879, "", "=q4=Heavy Dark Iron Ring", "=ds=#s13#", "", "2.32%"};
		{ 23, 19147, "", "=q4=Ring of Spell Power", "=ds=#s13#", "", "2.39%"};
		{ 24, 18878, "", "=q4=Sorcerous Dagger", "=ds=#h3#, #w4#", "", "2.53%"};
		{ 25, 17074, "", "=q4=Shadowstrike", "=ds=#w7#", "", "23.50%"};
		{ 26, 17077, "", "=q4=Crimson Shocker", "=ds=#w12#", "", "2.26%"};
	};
	...
	AtlasLoot_Data["BWLTrashMobs"] = {
		...
		{ 11, 18562, "", "=q4=Elementium Ore", "=ds=#e8#", "", "4.75%"};
		{ 13, 21109, "", "=q1=Draconic for Dummies", "=ds=#m3#"};
	};
	...
	AtlasLoot_Data["DMWPrinceTortheldrin"] = {
		...
		{ 10, 0, "INV_Box_01", "=q6=#x8#", ""};
		{ 11, 18336, "", "=q1=Gauntlet of Gordok Might", "=ds=#m3#"};
	...
	AtlasLoot_Data["ShadowfangKeep2"] = {
		...
		{ 13, 24224, "", "=q1=Crate of Bloodforged Ingots", "=ds=#m3#"};
		{ 14, 6895, "", "=q1=Jordan's Smithing Hammer", "=ds=#m3#"};
		{ 15, 6283, "", "=q1=The Book of Ur", "=ds=#m3#"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Trash Mobs"], ""};
	...
	AtlasLoot_Data["STRATCannonMasterWilley"] = {
		...
		{ 12, 12839, "", "=q3=Plans: Heartseeker", "=ds=#p2# (300)", "", "4.98%"};
		{ 13, 12783, "", "=q3=Heartseeker", "=ds=#h1#, #w4#"};
		{ 16, 16708, "", "=q3=Shadowcraft Spaulders", "=ds=#s3#, #a2# (D1, #c6#)", "", "10.68%"};
		{ 18, 21524, "", "=q2=Red Winter Hat", "=ds=#s1#, #a1# =q2=#m28#"};
	};
	...
	AtlasLoot_Data["T0Druid"] = {
		...
		{ 3, 16718, "", "=q3=Wildheart Spaulders", "=ds=Gizrul the Slavener (LBRS)", "", "11.04%"};
		...
		{ 6, 16717, "", "=q3=Wildheart Gloves", "=ds=The Unforgiven (Strat)", "", "12.61%"};
		...
		{ 9, 16715, "", "=q3=Wildheart Boots", "=ds=Mother Smolderweb (LBRS)", "", "13.03%"};
	...
	AtlasLoot_Data["T0Hunter"] = {
		...
		{ 3, 16679, "", "=q3=Beaststalker's Mantle", "=ds=Overlord Wyrmthalak (LBRS)", "", "9.89%"};
		...
		{ 6, 16676, "", "=q3=Beaststalker's Gloves", "=ds=War Master Voone (LBRS)", "", "9.15%"};
		...
		{ 9, 16675, "", "=q3=Beaststalker's Boots", "=ds=Nerub'enkan (Strat)", "", "13.62%"};
	...
	AtlasLoot_Data["T0Mage"] = {
		...
		{ 3, 16689, "", "=q3=Magister's Mantle", "=ds=Ras Frostwhisper (Scholo)", "", "11.93%"};
		...
		{ 6, 16684, "", "=q3=Magister's Gloves", "=ds=Doctor Theolen Krastinov (Scholo)", "", "9.75%"};
		...
		{ 9, 16682, "", "=q3=Magister's Boots", "=ds=Hearthsinger Forresten (Strat)", "", "10.86%"};
	...
	AtlasLoot_Data["T0Paladin"] = {
		...
		{ 3, 16729, "", "=q3=Lightforge Spaulders", "=ds=The Beast (UBRS)", "", "13.62%"};
		...
		{ 6, 16724, "", "=q3=Lightforge Gauntlets", "=ds=Timmy the Cruel (Strat)", "", "10.42%"};
		...
		{ 9, 16725, "", "=q3=Lightforge Boots", "=ds=Balnazzar (Strat)", "", "11.11%"};
	...
	AtlasLoot_Data["T0Priest"] = {
		...
		{ 3, 16695, "", "=q3=Devout Mantle", "=ds=Solakar Flamewreath (UBRS)", "", "12.84%"};
	...
	AtlasLoot_Data["T0Rogue"] = {
		...
		{ 3, 16708, "", "=q3=Shadowcraft Spaulders", "=ds=Cannon Master Willey (Strat)", "", "10.68%"};
		...
		{ 6, 16712, "", "=q3=Shadowcraft Gloves", "=ds=Shadow Hunter Vosh'gajin (LBRS)", "", "11.89%"};
		...
		{ 9, 16711, "", "=q3=Shadowcraft Boots", "=ds=Rattlegore (Scholo)", "", "14.32%"};
	...
	AtlasLoot_Data["T0Shaman"] = {
		...
		{ 3, 16669, "", "=q3=Pauldrons of Elements", "=ds=Gyth (UBRS)", "", "14.77%"};
		...
		{ 6, 16672, "", "=q3=Gauntlets of Elements", "=ds=Pyroguard Emberseer (UBRS)", "", "14.23%"};
		...
		{ 9, 16670, "", "=q3=Boots of Elements", "=ds=Highlord Omokk (LBRS)", "", "9.35%"};
	...
	AtlasLoot_Data["T0Warlock"] = {
		...
		{ 3, 16701, "", "=q3=Dreadmist Mantle", "=ds=Jandice Barov (Scholo)", "", "12.20%"};
		...
		{ 6, 16705, "", "=q3=Dreadmist Wraps", "=ds=Lorekeeper Polkelt (Scholo)", "", "14.54%"};
		...
		{ 9, 16704, "", "=q3=Dreadmist Sandals", "=ds=Baroness Anastari (Strat)", "", "13.16%"};
	...
	AtlasLoot_Data["T0Warrior"] = {
		...
		{ 3, 16733, "", "=q3=Spaulders of Valor", "=ds=Warchief Rend Blackhand (UBRS)", "", "13.39%"};
		...
		{ 6, 16737, "", "=q3=Gauntlets of Valor", "=ds=Ramstein the Gorger (Strat)", "", "9.58%"};
		...
		{ 9, 16734, "", "=q3=Boots of Valor", "=ds=Kirtonos the Herald (Scholo)", "", "11.12%"};
	...
	AtlasLoot_Data["T1T2Druid"] = {
		...
		{ 5, 16830, "", "=q4=Cenarion Bracers", "=ds=Trash Mobs", "", "0.17%"};
		{ 6, 16831, "", "=q4=Cenarion Gloves", "=ds="..BabbleBoss["Shazzrah"], "", "19.53%"};
		{ 7, 16828, "", "=q4=Cenarion Belt", "=ds=Trash Mobs", "", "0.16%"};
		...
		{ 21, 16899, "", "=q4=Stormrage Handguards", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "5.34%"};
	...
	AtlasLoot_Data["T1T2Hunter"] = {
		...
		{ 3, 16848, "", "=q4=Giantstalker's Epaulets", "=ds=Sulfuron Harbinger", "", "19.64%"};
		{ 4, 16845, "", "=q4=Giantstalker's Breastplate", "=ds="..BabbleBoss["Golemagg the Incinerator"], "", "15.83%"};
		{ 5, 16850, "", "=q4=Giantstalker's Bracers", "=ds=Trash Mobs", "", "0.18%"};
		{ 6, 16852, "", "=q4=Giantstalker's Gloves", "=ds="..BabbleBoss["Shazzrah"], "", "18.58%"};
		{ 7, 16851, "", "=q4=Giantstalker's Belt", "=ds=Trash Mobs", "", "0.17%"};
		{ 8, 16847, "", "=q4=Giantstalker's Leggings", "=ds="..BabbleBoss["Magmadar"], "", "13.28%"};
		{ 9, 16849, "", "=q4=Giantstalker's Boots", "=ds=Gehennas", "", "14.54%"};
		...
		{ 21, 16940, "", "=q4=Dragonstalker's Gauntlets", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "6.13%"};
	...
	AtlasLoot_Data["T1T2Mage"] = {
		...
		{ 5, 16799, "", "=q4=Arcanist Bindings", "=ds=Trash Mobs", "", "0.16%"};
		{ 6, 16801, "", "=q4=Arcanist Gloves", "=ds="..BabbleBoss["Shazzrah"], "", "19.59%"};
		{ 7, 16802, "", "=q4=Arcanist Belt", "=ds=Trash Mobs", "", "0.16%"};
		...
		{ 21, 16913, "", "=q4=Netherwind Gloves", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "7.37%"};
	...
	AtlasLoot_Data["T1T2Paladin"] = {
		...
		{ 5, 16857, "", "=q4=Lawbringer Bracers", "=ds=Trash Mobs", "", "0.11%"};
		{ 6, 16860, "", "=q4=Lawbringer Gauntlets", "=ds=Gehennas", "", "11.77%"};
		{ 7, 16858, "", "=q4=Lawbringer Belt", "=ds=Trash Mobs", "", "0.10%"};
		...
		{ 21, 16956, "", "=q4=Judgement Gauntlets", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "3.58%"};
	...
	AtlasLoot_Data["T1T2Priest"] = {
		...
		{ 3, 16816, "", "=q4=Mantle of Prophecy", "=ds=Sulfuron Harbinger", "", "21.06%"};
		{ 4, 16815, "", "=q4=Robes of Prophecy", "=ds="..BabbleBoss["Golemagg the Incinerator"], "", "15.65%"};
		{ 5, 16819, "", "=q4=Vambraces of Prophecy", "=ds=Trash Mobs", "", "0.16%"};
		{ 6, 16812, "", "=q4=Gloves of Prophecy", "=ds=Gehennas", "", "18.65%"};
		{ 7, 16817, "", "=q4=Girdle of Prophecy", "=ds=Trash Mobs", "", "0.18%"};
		...
		{ 21, 16920, "", "=q4=Handguards of Transcendence", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "6.01%"};
	...
	AtlasLoot_Data["T1T2Rogue"] = {
		...
		{ 3, 16823, "", "=q4=Nightslayer Shoulder Pads", "=ds=Sulfuron Harbinger", "", "20.66%"};
		{ 4, 16820, "", "=q4=Nightslayer Chestpiece", "=ds="..BabbleBoss["Golemagg the Incinerator"], "", "16.76%"};
		{ 5, 16825, "", "=q4=Nightslayer Bracelets", "=ds=Trash Mobs", "", "0.17%"};
		{ 6, 16826, "", "=q4=Nightslayer Gloves", "=ds=Gehennas", "", "19.47%"};
		{ 7, 16827, "", "=q4=Nightslayer Belt", "=ds=Trash Mobs", "", "0.15%"};
		...
		{ 21, 16907, "", "=q4=Bloodfang Gloves", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "6.84%"};
	...
	AtlasLoot_Data["T1T2Shaman"] = {
		...
		{ 5, 16840, "", "=q4=Earthfury Bracers", "=ds=Trash Mobs", "", "0.06%"};
		{ 6, 16839, "", "=q4=Earthfury Gauntlets", "=ds=Gehennas", "", "7.38%"};
		{ 7, 16838, "", "=q4=Earthfury Belt", "=ds=Trash Mobs", "", "0.07%"};
		...
		{ 21, 16948, "", "=q4=Gauntlets of Ten Storms", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "2.13%"};
	...
	AtlasLoot_Data["T1T2Warlock"] = {
		...
		{ 5, 16804, "", "=q4=Felheart Bracers", "=ds=Trash Mobs", "", "0.16%"};
		{ 6, 16805, "", "=q4=Felheart Gloves", "=ds="..BabbleBoss["Lucifron"], "", "14.89%"};
		{ 7, 16806, "", "=q4=Felheart Belt", "=ds=Trash Mobs", "", "0.19%"};
		...
		{ 21, 16928, "", "=q4=Nemesis Gloves", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "5.28%"};
	...
	AtlasLoot_Data["T1T2Warrior"] = {
		...
		{ 3, 16868, "", "=q4=Pauldrons of Might", "=ds=Sulfuron Harbinger", "", "21.14%"};
		{ 4, 16865, "", "=q4=Breastplate of Might", "=ds="..BabbleBoss["Golemagg the Incinerator"], "", "15.28%"};
		{ 5, 16861, "", "=q4=Bracers of Might", "=ds=Trash Mobs", "", "0.16%"};
		{ 6, 16863, "", "=q4=Gauntlets of Might", "=ds="..BabbleBoss["Lucifron"], "", "16.40%"};
		{ 7, 16864, "", "=q4=Belt of Might", "=ds=Trash Mobs", "", "0.16%"};
		{ 8, 16867, "", "=q4=Legplates of Might", "=ds="..BabbleBoss["Magmadar"], "", "13.97%"};
		{ 9, 16862, "", "=q4=Sabatons of Might", "=ds=Gehennas", "", "14.48%"};
		...
		{ 21, 16964, "", "=q4=Gauntlets of Wrath", "=ds=Firemaw, =ds=Ebonroc, =ds=Flamegor", "", "5.93%"};
	...
	AtlasLoot_Data["Mounts11"] = {
		{ 1, 0, "INV_BannerPVP_02", "=q6="..BabbleFaction["Darnassus"].." #j30#", ""};
		...
		{ 8, 0, "INV_BannerPVP_02", "=q6="..BabbleFaction["Gnomeregan Exiles"].." #j30#", ""};
		{ 9, 18772, "", "=q4=Swift Green Mechanostrider", "=ds=#e12#"};
		{ 10, 18773, "", "=q4=Swift White Mechanostrider", "=ds=#e12#"};
		{ 11, 18774, "", "=q4=Swift Yellow Mechanostrider", "=ds=#e12#"};
		{ 12, 8595, "", "=q3=Blue Mechanostrider", "=ds=#e12#"};
		{ 13, 13321, "", "=q3=Green Mechanostrider", "=ds=#e12#"};
		{ 14, 8563, "", "=q3=Red Mechanostrider", "=ds=#e12#"};
		{ 15, 13322, "", "=q3=Unpainted Mechanostrider", "=ds=#e12#"};
		{ 16, 0, "INV_BannerPVP_02", "=q6="..BabbleFaction["Ironforge"].." #j30#", ""};
		{ 17, 18786, "", "=q4=Swift Brown Ram", "=ds=#e12#"};
		{ 18, 18787, "", "=q4=Swift Gray Ram", "=ds=#e12#"};
		{ 19, 18785, "", "=q4=Swift White Ram", "=ds=#e12#"};
		{ 20, 5872, "", "=q3=Brown Ram", "=ds=#e12#"};
		{ 21, 5864, "", "=q3=Gray Ram", "=ds=#e12#"};
		{ 22, 5873, "", "=q3=White Ram", "=ds=#e12#"};
		{ 23, 0, "INV_BannerPVP_02", "=q6="..BabbleFaction["Stormwind"].." #j30#", ""};
		{ 24, 18777, "", "=q4=Swift Brown Steed", "=ds=#e12#"};
		{ 25, 18776, "", "=q4=Swift Palomino", "=ds=#e12#"};
		{ 26, 18778, "", "=q4=Swift White Steed", "=ds=#e12#"};
		{ 27, 2411, "", "=q3=Black Stallion Bridle", "=ds=#e12#"};
		{ 28, 5656, "", "=q3=Brown Horse Bridle", "=ds=#e12#"};
		{ 29, 5655, "", "=q3=Chestnut Mare Bridle", "=ds=#e12#"};
		{ 30, 2414, "", "=q3=Pinto Bridle", "=ds=#e12#"};
		Next = "Mounts12";
		Back = "MOUNTMENU";
	};

	AtlasLoot_Data["Mounts12"] = {
		{ 1, 0, "INV_BannerPVP_01", "=q6="..BabbleFaction["Darkspear Trolls"].." #j30#", ""};
		...
		{ 9, 0, "INV_BannerPVP_01", "=q6="..BabbleFaction["Orgrimmar"].." #j30#", ""};
		{ 10, 18796, "", "=q4=Horn of the Swift Brown Wolf", "=ds=#e12#"};
		{ 11, 18798, "", "=q4=Horn of the Swift Gray Wolf", "=ds=#e12#"};
		{ 12, 18797, "", "=q4=Horn of the Swift Timber Wolf", "=ds=#e12#"};
		{ 13, 5668, "", "=q3=Horn of the Brown Wolf", "=ds=#e12#"};
		{ 14, 5665, "", "=q3=Horn of the Dire Wolf", "=ds=#e12#"};
		{ 15, 1132, "", "=q3=Horn of the Timber Wolf", "=ds=#e12#"};
		{ 16, 0, "INV_BannerPVP_01", "=q6="..BabbleFaction["Thunder Bluff"].." #j30#", ""};
		{ 17, 18794, "", "=q4=Great Brown Kodo", "=ds=#e12#"};
		{ 18, 18795, "", "=q4=Great Gray Kodo", "=ds=#e12#"};
		{ 19, 18793, "", "=q4=Great White Kodo", "=ds=#e12#"};
		{ 20, 15290, "", "=q3=Brown Kodo", "=ds=#e12#"};
		{ 21, 15277, "", "=q3=Gray Kodo", "=ds=#e12#"};
		{ 24, 0, "INV_BannerPVP_01", "=q6="..BabbleFaction["Undercity"].." #j30#", ""};
		{ 25, 13334, "", "=q4=Green Skeletal Warhorse", "=ds=#e12#"};
		{ 26, 18791, "", "=q4=Purple Skeletal Warhorse", "=ds=#e12#"};
		{ 27, 13332, "", "=q4=Blue Skeletal Horse", "=ds=#e12#"};
		{ 28, 13333, "", "=q3=Brown Skeletal Horse", "=ds=#e12#"};
		{ 29, 13331, "", "=q3=Red Skeletal Horse", "=ds=#e12#"};
		Next = "Mounts13";
		Prev = "Mounts11";
		Back = "MOUNTMENU";
	};

	AtlasLoot_Data["Mounts13"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j35#", ""};
		{ 2, 21176, "", "=q5=Black Qiraji Resonating Crystal", "=q2=#m4#"};
		{ 3, 13335, "", "=q4=Deathcharger's Reins", "=q2=#n52#, =q1=#z6#", "", "0.10%"};
		{ 4, 19872, "", "=q4=Swift Razzashi Raptor", "=q2=#n33#, =q1=#z8#", "", "0.43%"};
		{ 5, 19902, "", "=q4=Swift Zulian Tiger", "=q2=#n28#, =q1=#z8#", "", " 0.70%"};
		{ 6, 23720, "", "=q4=Riding Turtle", "=q2=#m24#"};
		{ 8, 21218, "", "=q3=Blue Qiraji Resonating Crystal", "=q2=#n11#,  =q1=#z11#", "", "10.91%"};
		{ 9, 21323, "", "=q3=Green Qiraji Resonating Crystal", "=q2=#n11#,  =q1=#z11#", "", "11.77%"};
		{ 10, 21321, "", "=q3=Red Qiraji Resonating Crystal", "=q2=#n11#,  =q1=#z11#", "", "1.32%"};
		{ 11, 21324, "", "=q3=Yellow Qiraji Resonating Crystal", "=q2=#n11#,  =q1=#z11#", "", "12.64%"};
		...
		{ 20, 29465, "", "=q4=Black Battlestrider", "=ds=#e12# =ec1=#m7#"};
		{ 21, 29467, "", "=q4=Black War Ram", "=ds=#e12# =ec1=#m7#"};
		{ 22, 29468, "", "=q4=Black War Steed Bridle", "=ds=#e12# =ec1=#m7#"};
		{ 23, 29471, "", "=q4=Reins of the Black War Tiger", "=ds=#e12# =ec1=#m7#"};
		{ 24, 19030, "", "=q4=Stormpike Battle Charger", "=ds=#e12# =ec1=#m7#"};
		{ 25, 29466, "", "=q4=Black War Kodo", "=ds=#e12# =ec1=#m6#"};
		{ 26, 29469, "", "=q4=Horn of the Black War Wolf", "=ds=#e12# =ec1=#m6#"};
		{ 27, 29470, "", "=q4=Red Skeletal Warhorse", "=ds=#e12# =ec1=#m6#"};
	...
	AtlasLoot_Data["PVPWeapons1"] = {
		...
		{ 2, 18843, "", "=q4=Grand Marshal's Right Hand Blade", "=ds=#h3#, #w13#", "15300 #alliance# 20 #ab#", ""};
		{ 3, 18847, "", "=q4=Grand Marshal's Left Hand Blade", "=ds=#h4#, #w13#", "15300 #alliance# 20 #ab#", ""};
		{ 4, 23451, "", "=q4=Grand Marshal's Mageblade", "=ds=#h4#, #w4#", "15300 #alliance# 20 #ab#", ""};
		{ 5, 18838, "", "=q4=Grand Marshal's Dirk", "=ds=#h1#, #w4#", "15300 #alliance# 20 #ab#", ""};
		{ 6, 12584, "", "=q4=Grand Marshal's Longsword", "=ds=#h1#, #w10#", "15300 #alliance# 20 #ab#", ""};
		{ 7, 23456, "", "=q4=Grand Marshal's Swiftblade", "=ds=#h1#, #w10#", "15300 #alliance# 20 #ab#", ""};
		{ 8, 18876, "", "=q4=Grand Marshal's Claymore", "=ds=#h2#, #w10#", "30600 #alliance# 40 #av#", ""};
		{ 9, 18827, "", "=q4=Grand Marshal's Handaxe", "=ds=#h1#, #w1#", "15300 #alliance# 20 #ab#", ""};
		{ 10, 18830, "", "=q4=Grand Marshal's Sunderer", "=ds=#h2#, #w1#", "30600 #alliance# 40 #av#", ""};
		{ 11, 23454, "", "=q4=Grand Marshal's Warhammer", "=ds=#h3#, #w6#", "15300 #alliance# 20 #ab#", ""};
		{ 12, 18865, "", "=q4=Grand Marshal's Punisher", "=ds=#h1#, #w6#", "15300 #alliance# 20 #ab#", ""};
		{ 13, 18867, "", "=q4=Grand Marshal's Battle Hammer", "=ds=#h2#, #w6#", "30600 #alliance# 40 #av#", ""};
		{ 14, 23455, "", "=q4=Grand Marshal's Demolisher", "=ds=#h2#, #w6#", "30600 #alliance# 40 #av#", ""};
		{ 16, 0, "INV_BannerPVP_01", "=q6=#m6#", ""};
		{ 17, 18844, "", "=q4=High Warlord's Right Claw", "=ds=#h3#, #w13#", "15300 #horde# 20 #ab#", ""};
		{ 18, 18848, "", "=q4=High Warlord's Left Claw", "=ds=#h4#, #w13#", "15300 #horde# 20 #ab#", ""};
		{ 19, 23466, "", "=q4=High Warlord's Spellblade", "=ds=#h4#, #w4#", "15300 #horde# 20 #ab#", ""};
		{ 20, 18840, "", "=q4=High Warlord's Razor", "=ds=#h1#, #w4#", "15300 #horde# 20 #ab#", ""};
		{ 21, 16345, "", "=q4=High Warlord's Blade", "=ds=#h1#, #w10#", "15300 #horde# 20 #ab#", ""};
		{ 22, 23467, "", "=q4=High Warlord's Quickblade", "=ds=#h1#, #w10#", "15300 #horde# 20 #ab#", ""};
		{ 23, 18877, "", "=q4=High Warlord's Greatsword", "=ds=#h2#, #w10#", "30600 #horde# 40 #av#", ""};
		{ 24, 18828, "", "=q4=High Warlord's Cleaver", "=ds=#h1#, #w1#", "15300 #horde# 20 #ab#", ""};
		{ 25, 18831, "", "=q4=High Warlord's Battle Axe", "=ds=#h2#, #w1#", "30600 #horde# 40 #av#", ""};
		{ 26, 23464, "", "=q4=High Warlord's Battle Mace", "=ds=#h3#, #w6#", "15300 #horde# 20 #ab#", ""};
		{ 27, 18866, "", "=q4=High Warlord's Bludgeon", "=ds=#h1#, #w6#", "15300 #horde# 20 #ab#", ""};
		{ 28, 18868, "", "=q4=High Warlord's Pulverizer", "=ds=#h2#, #w6#", "30600 #horde# 40 #av#", ""};
		{ 29, 23465, "", "=q4=High Warlord's Destroyer", "=ds=#h2#, #w6#", "30600 #horde# 40 #av#", ""};
		Next = "PVPWeapons2";
	...
	AtlasLoot_Data["PVPWeapons2"] = {
		{ 1, 0, "INV_BannerPVP_02", "=q6=#m7#", ""};
		{ 2, 18869, "", "=q4=Grand Marshal's Glaive", "=ds=#w7#", "30600 #alliance# 40 #av#", ""};
		{ 3, 18873, "", "=q4=Grand Marshal's Stave", "=ds=#w9#", "30600 #alliance# 40 #av#", ""};
		{ 4, 18825, "", "=q4=Grand Marshal's Aegis", "=ds=#w8#", "15300 #alliance# 20 #ab#", ""};
		{ 5, 18833, "", "=q4=Grand Marshal's Bullseye", "=ds=#w2#", "15300 #alliance# 40 #ab#", ""};
		{ 6, 18836, "", "=q4=Grand Marshal's Repeater", "=ds=#w3#", "15300 #alliance# 40 #ab#", ""};
		{ 7, 18855, "", "=q4=Grand Marshal's Hand Cannon", "=ds=#w5#", "15300 #alliance# 40 #ab#", ""};
		{ 8, 23452, "", "=q4=Grand Marshal's Tome of Power", "=ds=#s15#", "15300 #alliance# 40 #ab#", ""};
		{ 9, 23453, "", "=q4=Grand Marshal's Tome of Restoration", "=ds=#s15#", "15300 #alliance# 40 #ab#", ""};
		{ 16, 0, "INV_BannerPVP_01", "=q6=#m6#", ""};
		{ 17, 18871, "", "=q4=High Warlord's Pig Sticker", "=ds=#w7#", "30600 #horde# 40 #av#", ""};
		{ 18, 18874, "", "=q4=High Warlord's War Staff", "=ds=#w9#", "30600 #horde# 40 #av#", ""};
		{ 19, 18826, "", "=q4=High Warlord's Shield Wall", "=ds=#w8#", "15300 #horde# 20 #ab#", ""};
		{ 20, 18835, "", "=q4=High Warlord's Recurve", "=ds=#w2#", "15300 #horde# 40 #ab#", ""};
		{ 21, 18837, "", "=q4=High Warlord's Crossbow", "=ds=#w3#", "15300 #horde# 40 #ab#", ""};
		{ 22, 18860, "", "=q4=High Warlord's Street Sweeper", "=ds=#w5#", "15300 #horde# 40 #ab#", ""};
		{ 23, 23468, "", "=q4=High Warlord's Tome of Destruction", "=ds=#s15#", "15300 #horde# 40 #ab#", ""};
		{ 24, 23469, "", "=q4=High Warlord's Tome of Mending", "=ds=#s15#", "15300 #horde# 40 #ab#", ""};
		Prev = "PVPWeapons1";
		Back = "LEVEL60PVPREWARDS";
	};
	...
	AtlasLoot_Data["PvP60Accessories2"] = {
		...
		{ 24, 15198, "", "=q1=Knight's Colors", "=ds=#s7#", "20 #av# 20 #ab#", ""};
	...
	AtlasLoot_Data["PvP60Accessories3"] = {
		...
		{ 24, 15199, "", "=q1=Stone Guard's Herald", "=ds=#s7#", "20 #av# 20 #ab#", ""};
