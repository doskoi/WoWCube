...
function MonkeyQuestInit_Font(bCrashFont)
	...
	if (bCrashFont) then
		...
		if ( GetLocale() == "zhCN") then
			MonkeyQuestInit_SetButtonFonts("Fonts\ZYHei.ttf", MonkeyQuestConfig[MonkeyQuest.m_strPlayer].m_iFontHeight);
		elseif ( GetLocale() == "zhTW" ) then
			MonkeyQuestInit_SetButtonFonts("Fonts\FZXHJW.TTF", MonkeyQuestConfig[MonkeyQuest.m_strPlayer].m_iFontHeight);
		else
			MonkeyQuestInit_SetButtonFonts("Fonts\ARIALN.TTF", MonkeyQuestConfig[MonkeyQuest.m_strPlayer].m_iFontHeight);
		end
	else
		-- Default look
		if ( GetLocale() == "zhCN") then
			MonkeyQuestInit_SetButtonFonts("Fonts\ZYKai_T.ttf", MonkeyQuestConfig[MonkeyQuest.m_strPlayer].m_iFontHeight);
		elseif ( GetLocale() == "zhTW" ) then
			MonkeyQuestInit_SetButtonFonts("Fonts\FZLBJW.TTF", MonkeyQuestConfig[MonkeyQuest.m_strPlayer].m_iFontHeight);
		else
			MonkeyQuestInit_SetButtonFonts("Fonts\SKURRI.TTF", MonkeyQuestConfig[MonkeyQuest.m_strPlayer].m_iFontHeight);
		end
		-- change the fonts
